...
namespace MakerShop.Web
{
    ...
    /// on MakerShop business rules and configuration of active web application.
    /// </summary>
    public static class WebflowManager
    {
        ...
        public static bool IsUsingOnePageCheckout()
        {
            ...
            if (context == null)
            {
                throw new MakerShopException("This method can only be called within an HTTP context.");
            }
        ...
        {            
            ...
            Store store = MakerShop.Common.Token.Instance.Store;
            if (store != null)
            {
            ...
            if (sp != null)
            {
                if ((sp.Theme != string.Empty) && (MakerShop.UI.Styles.Theme.Exists(sp.Theme)))
                {
                    theme = sp.Theme;
                }
            }
