...
namespace MakerShop.Web.UI.WebControls
{
    ...
    public class SearchKeywordValidator : Sample.Web.UI.Compatibility.BaseValidator
    {
        ...
        public bool EvaluateIsValid(string keyword)
        {
            ...
            string tempKeyword = Regex.Replace(keyword, "[ _%\\?\\*]", "");
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (this.RenderUplevel && this.Page != null)
            {
                ...
                {
                    string url = this.Page.ClientScript.GetWebResourceUrl(this.GetType(), "MakerShop.Web.UI.WebControls.SearchKeywordValidator.js");
