...
namespace MakerShop.Web.UI
{
    ...
    public class MakerShopPage : System.Web.UI.Page
    {
        private bool _HasBasketControl;
        private bool _PreserveWhitespace = true;

        public MakerShopPage()
        {
            this.PreInit += new EventHandler(MakerShopPage_PreInit);
        }
        ...
        void MakerShopPage_PreInit(object sender, EventArgs e)
        {
        ...
        protected virtual void InitializeTheme()
        {
            ...
            {
                if ((personalization.Theme != string.Empty) && (MakerShop.UI.Styles.Theme.Exists(personalization.Theme)))
                {
        ...
        protected override void SavePageStateToPersistenceMedium(object state)
        {
            ...
            try
            {
                ...
                MakerShopApplicationSection appConfig = MakerShopApplicationSection.GetSection(context.ApplicationInstance);
