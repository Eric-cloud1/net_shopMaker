namespace MakerShop.Data
{
    ...
    public abstract class Database
    {
        ...
        protected Database(string connectionString)
        {
            ...
            string commandTimeout = ConfigurationManager.AppSettings["MakerShop:SqlCommandTimeout"];
        ...
        /// <summary>
        /// Begins the audit transaction
        /// </summary>
        /// <param name="isolationLevel"></param>
        public bool BeginAuditTransaction()
        {
            if (!InAudit)
            {
        ...
        public void EndAuditTransaction()
        {
            CommitTransaction();
            InAudit = false;
        }
        ...
        private void DoLoadDataSet(DbCommand command, DataSet dataSet, string[] tableNames)
        {
            ...
            for (int i = 0; i < tableNames.Length; i++)
            {
                ...
                {
                    throw new ArgumentException(Resources.ExceptionNullOrEmptyString, "tableNames[" + i + "]");
                }
            }
        ...
        public DbCommand GetSqlStringCommand(string query)
        {
            ...
            {
                throw new ArgumentException(Resources.ExceptionNullOrEmptyString, "query");
            }
        ...
        public virtual DbCommand GetStoredProcCommand(string storedProcedureName)
        {
            ...
            {
                throw new ArgumentException(Resources.ExceptionNullOrEmptyString, "storedProcedureName");
            }
