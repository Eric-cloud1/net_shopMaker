...
namespace MakerShop.Reporting
{
    ...
    public class AffiliateSalesSummary
    {
        ...
        public AffiliateSalesSummary(int affiliateId,    DateTime startDate, DateTime endDate, int orderCount, LSDecimal productSubtotal, LSDecimal orderTotal, int successful, int pending)
        {
