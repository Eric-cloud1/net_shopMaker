...
namespace MakerShop.Orders.ChargeBack
{
    public partial class ChargeBackDetails : IPersistable
    {
        ...
        public static void LoadDataReader(ChargeBackDetails pChargeBackDetails, IDataReader dr)
        {
            ...
            pChargeBackDetails.ChargeBackStatus = NullableData.GetInt32(dr, 9);
        ...
        public virtual SaveResult Save()
        {
            if (this.IsDirty)
            {
                ...
                if (recordExists)
                {
                    ...
                    StringBuilder selectQuery = new StringBuilder();
                    selectQuery.Append("SELECT COUNT(*) As RecordCount FROM xm_ChargeBackDetails");
                    selectQuery.Append(" WHERE  OrderId = @OrderId AND  PaymentId = @PaymentId AND  TransactionId = @TransactionId ");
                ...
                if (recordExists)
                {
                    ...
                    updateQuery.Append("CreateDate = @CreateDate,InitiateDate = @InitiateDate,ReasonCode = @ReasonCode,ReasonDescription = @ReasonDescription,CaseNumber = @CaseNumber,ReferenceNumber = @ReferenceNumber,ChargeBackStatus = @ChargeBackStatus,Comment = @Comment");
                    ...
                    using (DbCommand updateCommand = database.GetSqlStringCommand(updateQuery.ToString()))
                    {
                        ...
                        database.AddInParameter(updateCommand, "@InitiateDate", System.Data.DbType.DateTime, this.InitiateDate);
                ...
                else
                {
                    ...
                    using (DbCommand insertCommand = database.GetSqlStringCommand(insertQuery.ToString()))
                    {
                        ...
                        database.AddInParameter(insertCommand, "@InitiateDate", System.Data.DbType.DateTime, this.InitiateDate);
