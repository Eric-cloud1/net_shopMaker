...
namespace MakerShop.Stores
{
    ...
    public partial class StoreDataSource
    {
        ...
        public static Store CreateStore(string storeName, string adminEmail, string adminPassword, bool switchContext)
        {
            ...
            newStore.WeightUnit = MakerShop.Shipping.WeightUnit.Pounds;
            newStore.MeasurementUnit = MakerShop.Shipping.MeasurementUnit.Inches;
            newStore.Save();
            ...
            MakerShop.Users.Group suGroup = GroupDataSource.LoadForName("Super Users");
        ...
        public static int GetMaxOrderNumber()
        {
            ...
            DbCommand selectCommand = database.GetSqlStringCommand("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT MAX(OrderNumber) FROM ac_Orders WHERE StoreId = @storeId");
        ...
        {
            Database database = Token.Instance.Database;
            DbCommand selectCommand = database.GetSqlStringCommand("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT NextOrderId FROM ac_Stores WHERE StoreId = @storeId");
            database.AddInParameter(selectCommand, "@storeId", System.Data.DbType.Int32, Token.Instance.StoreId);
            return AlwaysConvert.ToInt(database.ExecuteScalar(selectCommand));
        }
        ...
        {
            Database database = Token.Instance.Database;
            DbCommand selectCommand = database.GetSqlStringCommand("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT COUNT(1) AS TotalCount FROM ac_Stores");
