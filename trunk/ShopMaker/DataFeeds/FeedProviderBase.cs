...
namespace MakerShop.DataFeeds
{
    ...
    public abstract class FeedProviderBase : IFeedProvider
    {
        ...
        {            
            ...
            UpdateStatus(100, "Feed file generated.", true);
            return true;
        }
        ...
        {            
            ...
            UpdateStatus(100, "Feed File Compressed.", true);
            return true;
        }
        ...
        private static void UploadFile(FeedOptions options, string localFilePath, string remoteFileName)
        {
            ...
            else throw new MakerShop.Exceptions.SecurityException("The application requires at least Medium trust and WebPermission credentials to perform FTP operations.");
        }
