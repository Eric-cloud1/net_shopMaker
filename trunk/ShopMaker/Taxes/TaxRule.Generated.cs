...
#region Constructors
        ...
        public static void LoadDataReader(TaxRule taxRule, IDataReader dr)
        {
            ...
            taxRule.CountryCode = NullableData.GetString(dr, 2);
            taxRule.ProvinceId = NullableData.GetInt32(dr, 3);
            taxRule.Name = dr.GetString(4);
            taxRule.PostalCodeFilter = NullableData.GetString(dr, 5);
            taxRule.TaxRate = dr.GetDecimal(6);
            taxRule.UseBillingAddress = dr.GetBoolean(7);
            taxRule.GroupRuleId = dr.GetByte(8);
            taxRule.TaxCodeId = NullableData.GetInt32(dr, 9);
            taxRule.Priority = dr.GetInt16(10);
            taxRule.RoundingRuleId = dr.GetByte(11);
            taxRule.UsePerItemTax = dr.GetBoolean(12);
...
#region Parents
        ...
        /// <summary>
        /// The Country object that this TaxRule object is associated with
        /// </summary>
        ...
        /// <summary>
        /// The Province object that this TaxRule object is associated with
        /// </summary>
        ...
        public virtual SaveResult Save()
        {
            if (this.IsDirty)
            {
                ...
                if (recordExists) {
                    ...
                    StringBuilder selectQuery = new StringBuilder();
                    selectQuery.Append("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT COUNT(1) As RecordCount FROM ac_TaxRules");
                    selectQuery.Append(" WHERE TaxRuleId = @taxRuleId");
                ...
                if (recordExists)
                {
                    ...
                    updateQuery.Append(", ProvinceId = @ProvinceId");
                    ...
                    using (DbCommand updateCommand = database.GetSqlStringCommand(updateQuery.ToString()))
                    {
                        ...
                        database.AddInParameter(updateCommand, "@ProvinceId", System.Data.DbType.Int32, NullableData.DbNullify(this.ProvinceId));
                ...
                else
                {
                    ...
                    insertQuery.Append("INSERT INTO ac_TaxRules (StoreId, CountryCode, ProvinceId, Name, PostalCodeFilter, TaxRate, UseBillingAddress, GroupRuleId, TaxCodeId, Priority, RoundingRuleId, UsePerItemTax)");
                    insertQuery.Append(" VALUES (@StoreId, @CountryCode, @ProvinceId, @Name, @PostalCodeFilter, @TaxRate, @UseBillingAddress, @GroupRuleId, @TaxCodeId, @Priority, @RoundingRuleId, @UsePerItemTax)");
                    ...
                    using (DbCommand insertCommand = database.GetSqlStringCommand(insertQuery.ToString()))
                    {
                        ...
                        database.AddInParameter(insertCommand, "@ProvinceId", System.Data.DbType.Int32, NullableData.DbNullify(this.ProvinceId));
