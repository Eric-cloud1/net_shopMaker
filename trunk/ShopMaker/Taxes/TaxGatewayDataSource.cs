...
namespace MakerShop.Taxes
{
    ...
    public partial class TaxGatewayDataSource
    {
        ...
        public static int GetTaxGatewayIdByClassId(string classId)
        {
            ...
            DbCommand selectCommand = database.GetSqlStringCommand("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT TaxGatewayId FROM ac_TaxGateways WHERE StoreId=@storeId AND ClassId=@classId");
