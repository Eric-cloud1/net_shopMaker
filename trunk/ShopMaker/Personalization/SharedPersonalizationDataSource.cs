...
namespace MakerShop.Personalization
{
    ...
    public partial class SharedPersonalizationDataSource
    {
        ...
        public static SharedPersonalization LoadForPath(string path, bool create)
        {
            ...
            selectQuery.Append("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT " + SharedPersonalization.GetColumnNames("acSP"));
        ...
        public static PersonalizationStateInfoCollection FindState(PersonalizationStateQuery query, int pageIndex, int pageSize, out int totalRecords)
        {
            ...
            selectQuery.Append("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT " + SharedPersonalization.GetColumnNames("S") + ",P.Path");
