...
#region Constructors
        ...
        public static string GetColumnNames(string prefix)
        {
          ...
          columnNames.Add(prefix + "CountryCode3");
        ...
        public static void LoadDataReader(Country country, IDataReader dr)
        {
            ...
            country.CountryCode3 = NullableData.GetString(dr, 4);
        ...
        private String _CountryCode3 = string.Empty;
        ...
        public virtual void EnsureChildProperties()
        {
            ...
            if (this.TaxRulesLoaded) { foreach (TaxRule taxRule in this.TaxRules) { taxRule.CountryCode = this.CountryCode; } }
...
#region Children
        ...
        /// <summary>
        /// A collection of TaxRule objects associated with this Country object.
        /// </summary>
        public TaxRuleCollection TaxRules
        {
            get
            {
                ...
                {
                    this._TaxRules = TaxRuleDataSource.LoadForCountry(this.CountryCode);
                }
        ...
        public virtual SaveResult Save()
        {
            if (this.IsDirty)
            {
                ...
                if (recordExists) {
                    ...
                    StringBuilder selectQuery = new StringBuilder();
                    selectQuery.Append("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT COUNT(1) As RecordCount FROM ac_Countries");
                    selectQuery.Append(" WHERE CountryCode = @countryCode");
                ...
                else
                {
                    ...
                    insertQuery.Append("INSERT INTO ac_Countries (CountryCode, StoreId, Name, AddressFormat, CountryCode3)");
                    insertQuery.Append(" VALUES (@CountryCode, @StoreId, @Name, @AddressFormat, @CountryCode3)");
                    using (DbCommand insertCommand = database.GetSqlStringCommand(insertQuery.ToString()))
                    {
                        ...
                        database.AddInParameter(insertCommand, "@CountryCode3", System.Data.DbType.String, this.CountryCode3);
                        //RESULT IS NUMBER OF RECORDS AFFECTED;
