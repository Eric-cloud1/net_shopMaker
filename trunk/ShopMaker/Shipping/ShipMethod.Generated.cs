...
#region Constructors
        ...
        public static void LoadDataReader(ShipMethod shipMethod, IDataReader dr)
        {
            ...
            shipMethod.OrderBy = dr.GetInt16(11);
        ...
        public virtual SaveResult Save()
        {
            if (this.IsDirty)
            {
                ...
                if (recordExists) {
                    ...
                    StringBuilder selectQuery = new StringBuilder();
                    selectQuery.Append("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT COUNT(1) As RecordCount FROM ac_ShipMethods");
                    selectQuery.Append(" WHERE ShipMethodId = @shipMethodId");
                ...
                else
                {
                    ...
                    insertQuery.Append("INSERT INTO ac_ShipMethods (StoreId, ShipMethodTypeId, Name, Surcharge, ShipGatewayId, ServiceCode, MinPurchase, SurchargeIsVisible, SurchargeIsPercent, TaxCodeId, OrderBy)");
                    insertQuery.Append(" VALUES (@StoreId, @ShipMethodTypeId, @Name, @Surcharge, @ShipGatewayId, @ServiceCode, @MinPurchase, @SurchargeIsVisible, @SurchargeIsPercent, @TaxCodeId, @OrderBy)");
