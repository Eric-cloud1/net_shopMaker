        ...
        public virtual SaveResult Save()
        {
            if (this.IsDirty)
            {
                ...
                if (recordExists) {
                    ...
                    StringBuilder selectQuery = new StringBuilder();
                    selectQuery.Append("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT COUNT(1) As RecordCount FROM ac_ShipZones");
                    selectQuery.Append(" WHERE ShipZoneId = @shipZoneId");
                ...
                else
                {
                    ...
                    insertQuery.Append("INSERT INTO ac_ShipZones (StoreId, Name, CountryRuleId, ProvinceRuleId, PostalCodeFilter, ExcludePostalCodeFilter)");
                    insertQuery.Append(" VALUES (@StoreId, @Name, @CountryRuleId, @ProvinceRuleId, @PostalCodeFilter, @ExcludePostalCodeFilter)");
