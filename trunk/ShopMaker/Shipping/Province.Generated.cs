...
#region Constructors
        ...
        public virtual void EnsureChildProperties()
        {
            ...
            if (this.TaxRulesLoaded) { foreach (TaxRule taxRule in this.TaxRules) { taxRule.ProvinceId = this.ProvinceId; } }
        }
...
#region Children
        ...
        /// <summary>
        /// A collection of TaxRule objects associated with this Province object.
        /// </summary>
        public TaxRuleCollection TaxRules
        {
            get
            {
                ...
                {
                    this._TaxRules = TaxRuleDataSource.LoadForProvince(this.ProvinceId);
                }
        ...
        public virtual SaveResult Save()
        {
            if (this.IsDirty)
            {
                ...
                if (recordExists) {
                    ...
                    StringBuilder selectQuery = new StringBuilder();
                    selectQuery.Append("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT COUNT(1) As RecordCount FROM ac_Provinces");
                    selectQuery.Append(" WHERE ProvinceId = @provinceId");
