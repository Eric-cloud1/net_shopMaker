...
namespace MakerShop.Marketing
{
    ...
    public partial class EmailListDataSource
    {
        ...
        public static int CountForEmail(string email)
        {
            ...
            DbCommand selectCommand = database.GetSqlStringCommand("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT COUNT(DISINCT EmailListId) AS TotalRecords FROM ac_EmailListUsers WHERE Email = @email");
