...
namespace MakerShop.Marketing
{
    ...
    public partial class VolumeDiscountDataSource
    {
        ...
        public static int[] GetGlobalVolumeDiscountIds()
        {
            ...
            DbCommand command = database.GetSqlStringCommand("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT VolumeDiscountId FROM ac_VolumeDiscounts WHERE StoreId = @storeId AND IsGlobal = 1");
        ...
        {
            Database database = Token.Instance.Database;
            DbCommand selectCommand = database.GetSqlStringCommand("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT COUNT(1) AS TotalRecords FROM ac_CategoryVolumeDiscounts WHERE StoreId = @storeId AND IsGlobal = 1");
        ...
        private static VolumeDiscountCollection GetCategoryDiscountsForProduct(int productId)
        {
            ...
            categorySql.Append("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT DISTINCT CP.ParentLevel,CVD.VolumeDiscountId");
