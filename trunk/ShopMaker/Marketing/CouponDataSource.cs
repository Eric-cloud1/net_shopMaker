...
namespace MakerShop.Marketing
{
    ...
    public partial class CouponDataSource
    {
        ...
        public static int CountUses(string couponCode)
        {
            ...
            selectQuery.Append("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT COUNT(1)");
        ...
        public static Coupon LoadForCouponCode(string couponCode)
        {
            ...
            //CREATE THE DYNAMIC SQL TO LOAD OBJECT
            StringBuilder selectQuery = new StringBuilder();
            selectQuery.Append("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT CouponId");
