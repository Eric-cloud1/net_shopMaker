...
#region Constructors
        ...
        public static string GetColumnNames(string prefix)
        {
          ...
          columnNames.Add(prefix + "Active");
          columnNames.Add(prefix + "PromoCode");
          columnNames.Add(prefix + "ParentAffiliateID");
          columnNames.Add(prefix + "AffiliateTypeId");
          columnNames.Add(prefix + "RoutingNumber");
          columnNames.Add(prefix + "AccountNumber");
        ...
        public static void LoadDataReader(Affiliate affiliate, IDataReader dr)
        {
            ...
            affiliate.Active = dr.GetBoolean(22);
            affiliate.PromoCode =  NullableData.GetString(dr, 23);
            affiliate.ParentAffiliateID = NullableData.GetInt32(dr,24);
            affiliate.AffiliateTypeId = NullableData.GetByte(dr, 25);
            affiliate.RoutingNumber = NullableData.GetString(dr, 26);
            affiliate.AccountNumber = NullableData.GetString(dr, 27);
        ...
        private Int32? _ParentAffiliateID;
        private byte _AffiliateTypeId;
        ...
        /// ParentAffiliateID
        /// </summary>
        public Int32? ParentAffiliateID
        {
            get { return this._ParentAffiliateID; }
            set
            {
                if (this._ParentAffiliateID != value)
                {
                    this._ParentAffiliateID = value;
                    this.IsDirty = true;
                }
            }
        }
        ...
        /// </summary>
        /// 
        private Affiliate _ParentAffiliate ;
        public string ParentAffiliate
        {
           
            get
            {
                if (this._ParentAffiliate == null)
                {
                    _ParentAffiliate = new Affiliate();
                    _ParentAffiliate.Load(this.ParentAffiliateID.Value);
                }
                    return _ParentAffiliate.Name;
            }
        }
        ...
        /// AffiliateTypeId
        /// </summary>
        public byte AffiliateTypeId
        {
            get { return this._AffiliateTypeId; }
            set
            {
                if (this._AffiliateTypeId != value)
                {
                    this._AffiliateTypeId = value;
                    this.IsDirty = true;
                }
            }
        }
...
#region Children
        ...
        /// <summary>
        /// The gatewayTemplate object associated with this Affiliate
        /// </summary>
        /// 
        private Payments.PaymentGatewayTemplate_Affiliate _PaymentGatewayTemplate_Affiliate;
        public Payments.PaymentGatewayTemplate_Affiliate PaymentGatewayTemplate_Affiliate
        {
            get
            {
                if (!this.PaymentGatewayTemplate_AffiliateLoaded)
                {
                    this._PaymentGatewayTemplate_Affiliate = Payments.PaymentGatewayTemplate_AffiliateDataSource.Load(this.AffiliateId);
                }
                return this._PaymentGatewayTemplate_Affiliate;
            }
        }

        [EditorBrowsable(EditorBrowsableState.Advanced)]
        internal bool PaymentGatewayTemplate_AffiliateLoaded { get { return (this.PaymentGatewayTemplate_Affiliate != null); } }
        ...
        public virtual SaveResult Save()
        {
            if (this.IsDirty)
            {
                ...
                if (recordExists) {
                    ...
                    StringBuilder selectQuery = new StringBuilder();
                    selectQuery.Append("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT COUNT(1) As RecordCount FROM ac_Affiliates");
                    selectQuery.Append(" WHERE AffiliateId = @affiliateId");
                ...
                if (recordExists)
                {
                    ...
                    updateQuery.Append(", PromoCode = @PromoCode");
                    updateQuery.Append(", ParentAffiliateID = @ParentAffiliateID");
                    ...
                    using (DbCommand updateCommand = database.GetSqlStringCommand(updateQuery.ToString()))
                    {
                        ...
                        database.AddInParameter(updateCommand, "@Active", System.Data.DbType.Boolean, this.Active);
                        database.AddInParameter(updateCommand, "@PromoCode", System.Data.DbType.String, this.PromoCode);
                        database.AddInParameter(updateCommand, "@ParentAffiliateID", System.Data.DbType.Int16, this.ParentAffiliateID);
                ...
                else
                {
                    ...
                    insertQuery.Append("INSERT INTO ac_Affiliates (StoreId, Name, PayeeName, FirstName, LastName, Company, Address1, Address2, City, Province, PostalCode, CountryCode, PhoneNumber, FaxNumber, MobileNumber, WebsiteUrl, Email, CommissionRate, CommissionIsPercent, CommissionOnTotal, ReferralDays, Active)");
                    insertQuery.Append(" VALUES (@StoreId, @Name, @PayeeName, @FirstName, @LastName, @Company, @Address1, @Address2, @City, @Province, @PostalCode, @CountryCode, @PhoneNumber, @FaxNumber, @MobileNumber, @WebsiteUrl, @Email, @CommissionRate, @CommissionIsPercent, @CommissionOnTotal, @ReferralDays, @Active)");
                    ...
                    using (DbCommand insertCommand = database.GetSqlStringCommand(insertQuery.ToString()))
                    {
                        ...
                        database.AddInParameter(insertCommand, "@Active", System.Data.DbType.Boolean, this.Active );

                        database.AddInParameter(insertCommand, "@PromoCode", System.Data.DbType.String, this.PromoCode);
                        database.AddInParameter(insertCommand, "@ParentAffiliateID", System.Data.DbType.Int16, this.ParentAffiliateID);
        ...
        public virtual void SaveChildren()
        {
            ...
            if (this.PaymentGatewayTemplate_AffiliateLoaded) this.PaymentGatewayTemplate_Affiliate.Save();
        }
