...
namespace MakerShop.Marketing
{
    ...
    public partial class EmailListSignupDataSource
    {
        ...
        public static int GetEmailListSignupId(int emailListId, string email)
        {
            ...
            DbCommand selectCommand = database.GetSqlStringCommand("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT EmailListSignupId FROM ac_EmailListSignups WHERE EmailListId = @emailListId AND Email = @email");
