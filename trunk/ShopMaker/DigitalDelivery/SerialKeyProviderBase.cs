...
namespace MakerShop.DigitalDelivery
{
    ...
    public abstract class SerialKeyProviderBase : ISerialKeyProvider
    {
        ...
        /// </summary>
        public virtual bool Login(string username, string password, out string URL, out List<string> messages)
        {
        ...
        public virtual AcquireSerialKeyResponse UpgradeSerialKey(OrderItemDigitalGood oidg, string newLevel)
        {
