...
#region Constructors
        ...
        public static string GetColumnNames(string prefix)
        {
          ...
          columnNames.Add(prefix + "RequestData");
        ...
        public static void LoadDataReader(Transaction transaction, IDataReader dr)
        {
            ...
            transaction.RequestData = NullableData.GetString(dr, 17);
            transaction.StartDate = NullableData.GetDateTime(dr, 18);
            transaction.EndDate = NullableData.GetDateTime(dr, 19);
        ...
        public  Orders.ChargeBack.ChargeBackDetails ChargeBacks
        {
            get
            {
               
               return MakerShop.Orders.ChargeBack.ChargeBackDetailsDataSource.LoadByTransactionId(this.TransactionId);  
            }
        }

        public DateTime ChargeBackDateInitiated
        {
            get
            {

                return ChargeBacks.InitiateDate;
                
            }
        }

        public DateTime ChargeBackCreateDate
        {
            get
            {

                return ChargeBacks.CreateDate;
        ...
        public virtual SaveResult Save()
        {
            if (this.IsDirty)
            {
                ...
                if (recordExists) {
                    ...
                    StringBuilder selectQuery = new StringBuilder();
                    selectQuery.Append("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT COUNT(1) As RecordCount FROM ac_Transactions");
                    selectQuery.Append(" WHERE TransactionId = @transactionId");
                ...
                if (recordExists)
                {
                    ...
                    updateQuery.Append(", RequestData = @RequestData");
                    ...
                    using (DbCommand updateCommand = database.GetSqlStringCommand(updateQuery.ToString()))
                    {
                        ...
                        database.AddInParameter(updateCommand, "@RequestData", System.Data.DbType.String, NullableData.DbNullify(this.RequestData));
                        if (this.StartDate != DateTime.MinValue)
                            database.AddInParameter(updateCommand, "@StartDate", System.Data.DbType.DateTime, LocaleHelper.FromLocalTime(this.StartDate));
                        else
                            database.AddInParameter(updateCommand, "@StartDate", System.Data.DbType.DateTime, DBNull.Value);
                        if (this.EndDate!= DateTime.MinValue)
                            database.AddInParameter(updateCommand, "@EndDate", System.Data.DbType.DateTime, LocaleHelper.FromLocalTime(this.EndDate));
                        else
                            database.AddInParameter(updateCommand, "@EndDate", System.Data.DbType.DateTime, DBNull.Value);
                ...
                else
                {
                    ...
                    insertQuery.Append("INSERT INTO ac_Transactions (TransactionTypeId, PaymentId, PaymentGatewayId, ProviderTransactionId, TransactionDate, Amount, TransactionStatusId, ResponseCode, ResponseMessage, AuthorizationCode, AVSResultCode, CVVResultCode, CAVResultCode, RemoteIP, Referrer, AdditionalData, RequestData, StartDate, EndDate)");
                    insertQuery.Append(" VALUES (@TransactionTypeId, @PaymentId, @PaymentGatewayId, @ProviderTransactionId, @TransactionDate, @Amount, @TransactionStatusId, @ResponseCode, @ResponseMessage, @AuthorizationCode, @AVSResultCode, @CVVResultCode, @CAVResultCode, @RemoteIP, @Referrer, @AdditionalData, @RequestData, @StartDate, @EndDate)");
                    ...
                    using (DbCommand insertCommand = database.GetSqlStringCommand(insertQuery.ToString()))
                    {
                        ...
                        database.AddInParameter(insertCommand, "@RequestData", System.Data.DbType.String, NullableData.DbNullify(this.RequestData));
                        if (this.StartDate != DateTime.MinValue)
                            database.AddInParameter(insertCommand, "@StartDate", System.Data.DbType.DateTime, LocaleHelper.FromLocalTime(this.StartDate));
                        else
                            database.AddInParameter(insertCommand, "@StartDate", System.Data.DbType.DateTime, DBNull.Value);
                        if (this.EndDate != DateTime.MinValue)
                            database.AddInParameter(insertCommand, "@EndDate", System.Data.DbType.DateTime, LocaleHelper.FromLocalTime(this.EndDate));
                        else
                            database.AddInParameter(insertCommand, "@EndDate", System.Data.DbType.DateTime, DBNull.Value);
