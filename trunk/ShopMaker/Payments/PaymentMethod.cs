...
namespace MakerShop.Payments
{
    public partial class PaymentMethod
    {
        ...
        {
            return ((this.PaymentInstrument == PaymentInstrument.AmericanExpress) || (this.PaymentInstrument == PaymentInstrument.DinersClub) || (this.PaymentInstrument == PaymentInstrument.Discover) || (this.PaymentInstrument == PaymentInstrument.JCB) || (this.PaymentInstrument == PaymentInstrument.MasterCard) || (this.PaymentInstrument == PaymentInstrument.Visa));
        }
