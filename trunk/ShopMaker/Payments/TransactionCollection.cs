namespace MakerShop.Payments
{
    ...
    public partial class TransactionCollection
    {
        ...
        /// </summary>
        public Transaction LastAuthorizationAny
        {
            get
            {
        ...
        /// <summary>
        /// Gets the last successful authorization transaction in this collection
        /// </summary>
        ...
        /// </summary>
        public Transaction LastCaptureAny
        {
            get
            {
                int index = this.Count - 1;
        ...
        /// <summary>
        /// Gets the last successful capture transaction in this collection
        /// </summary>
        ...
        /// <summary>
        /// Gets the last successful refund transaction in this collection
        /// </summary>
        public Transaction LastRefund
        {
            get
            {
                int index = this.Count - 1;
