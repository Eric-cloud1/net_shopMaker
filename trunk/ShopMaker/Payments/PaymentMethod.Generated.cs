...
#region Constructors
        ...
        public static void LoadDataReader(PaymentMethod paymentMethod, IDataReader dr)
        {
            ...
            paymentMethod.Active = dr.GetBoolean(6);
        ...
        public virtual SaveResult Save()
        {
            if (this.IsDirty)
            {
                ...
                if (recordExists) {
                    ...
                    StringBuilder selectQuery = new StringBuilder();
                    selectQuery.Append("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT COUNT(1) As RecordCount FROM ac_PaymentMethods");
                    selectQuery.Append(" WHERE PaymentMethodId = @paymentMethodId");
                ...
                if (recordExists)
                {
                    ...
                    using (DbCommand updateCommand = database.GetSqlStringCommand(updateQuery.ToString()))
                    {
                        ...
                        database.AddInParameter(updateCommand, "@Active", System.Data.DbType.Byte, this.Active);
