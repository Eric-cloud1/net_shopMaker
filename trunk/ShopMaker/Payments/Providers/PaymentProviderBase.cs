...
namespace MakerShop.Payments.Providers
{
    /// <summary>
    ...
    public abstract class PaymentProviderBase : IPaymentProvider
    {
        ...
        /// <summary>
        /// Submits a update request for a pending payment.
        /// </summary>
        /// <param name="noCardResponse">The response to parse and turn into a transaction</param>
        /// <returns>Transaction that represents the result of the update request</returns>
        public virtual Transaction DoUpdate(NoCardTransactionResponse noCardResponse)
        {
