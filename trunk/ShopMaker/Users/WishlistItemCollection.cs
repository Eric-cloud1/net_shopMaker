namespace MakerShop.Users
{
    ...
    public partial class WishlistItemCollection
    {
        ...
        internal BasketItem GetBasketItem(int index, Basket basket)
        {
            ...
            BasketItem basketItem = BasketItemDataSource.CreateForProduct(item.ProductId, item.Desired, item.OptionList, item.KitList, MakerShop.Payments.PaymentTypes.Initial);
