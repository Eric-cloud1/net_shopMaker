...
namespace MakerShop.Users
{
    ...
    public partial class User
    {
        ...
        internal bool OptIns_Loaded { get { return (this._OptIns != null); } }


        private OptInCollection _OptIns;


        /// <summary>
        /// User object associated with this Order object.
        /// </summary>
        public OptInCollection OptIns
        {
            get
            {
                if (!this.OptIns_Loaded)
                {
                    this._OptIns = OptInDataSource.LoadForUser(this.UserId);
                }
                return this._OptIns;
            }
        }
        ...
        public virtual SaveResult Save()
        {
            ...
            this.IsAnonymous = (MakerShop.Utility.AlwaysConvert.ToGuid(this.UserName) != Guid.Empty);
        ...
        {
            User.Migrate(oldUser, newUser, false);
        }
        ...
        public static void Migrate(User oldUser, User newUser, bool includeOrderData)
        {
        ...
        public bool IsJrAdmin
        {
            get
            {
                return this.IsInRole(Role.JrAdminRoles);
            }
        }
        ...
        public bool IsGateway
        {
            get
            {
                return this.IsInRole(Role.GatewayRoles);
            }
        }
        ...
        public bool IsGatewayAdmin
        {
            get
            {
                return this.IsInRole(Role.GatewayAdminRoles);
            }
        }
        ...
        internal void ValidateAffiliate()
        {
            ...
            if (affiliate != null)
            {
                ...
                if (affiliate.ReferralDays == 0)
                {
                    //PERSISTENT AFFILIATE
                    affiliateValid = true;
                }
                else
                {
                    //AFFILIATE IS NOT PERSISTENT
                    DateTime validThrough = this.AffiliateReferralDate.AddDays(affiliate.ReferralDays);
                    affiliateValid = (validThrough >= LocaleHelper.LocalNow);
                }
            }
