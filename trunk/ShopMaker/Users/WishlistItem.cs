...
namespace MakerShop.Users
{
    ...
    public partial class WishlistItem
    {
        ...
        public virtual SaveResult Save()
        {
            ...
            {
                this.Delete();
                return MakerShop.Common.SaveResult.RecordDeleted;
            }
        ...
        public void Recalculate()
        {
            ...
            ProductCalculator pcalc = ProductCalculator.LoadForProduct(this.ProductId, this.Desired, this.OptionList, this.KitList, this.Wishlist.UserId, PaymentTypes.Initial);
