...
namespace MakerShop.Users
{
    ...
    public partial class RoleDataSource
    {
        ...
        public static int CountForCriteria(string sqlCriteria)
        {
            ...
            DbCommand selectCommand = database.GetSqlStringCommand("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT COUNT(1) AS TotalRecords FROM ac_Roles" + whereClause);
        ...
        {
            Database database = Token.Instance.Database;
            DbCommand selectCommand = database.GetSqlStringCommand("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT COUNT(1) AS TotalRecords FROM ac_GroupRoles WHERE GroupId = @groupId");
