...
#region Constructors
        ...
        public static string GetColumnNames(string prefix)
        {
          ...
          columnNames.Add(prefix + "ReferringAffiliateId");
        ...
        public static void LoadDataReader(User user, IDataReader dr)
        {
            ...
            user.ReferringAffiliateId = NullableData.GetInt32(dr, 4);
            user.AffiliateId = NullableData.GetInt32(dr, 5);
            user.AffiliateReferralDate = LocaleHelper.ToLocalTime(NullableData.GetDateTime(dr, 6));
            user.PrimaryAddressId = NullableData.GetInt32(dr, 7);
            user.PrimaryWishlistId = NullableData.GetInt32(dr, 8);
            user.PayPalId = NullableData.GetString(dr, 9);
            user.PasswordQuestion = NullableData.GetString(dr, 10);
            user.PasswordAnswer = NullableData.GetString(dr, 11);
            user.IsApproved = dr.GetBoolean(12);
            user.IsAnonymous = dr.GetBoolean(13);
            user.IsLockedOut = dr.GetBoolean(14);
            user.CreateDate = LocaleHelper.ToLocalTime(dr.GetDateTime(15));
            user.LastActivityDate = LocaleHelper.ToLocalTime(NullableData.GetDateTime(dr, 16));
            user.LastLoginDate = LocaleHelper.ToLocalTime(NullableData.GetDateTime(dr, 17));
            user.LastPasswordChangedDate = LocaleHelper.ToLocalTime(NullableData.GetDateTime(dr, 18));
            user.LastLockoutDate = LocaleHelper.ToLocalTime(NullableData.GetDateTime(dr, 19));
            user.FailedPasswordAttemptCount = dr.GetInt32(20);
            user.FailedPasswordAttemptWindowStart = LocaleHelper.ToLocalTime(NullableData.GetDateTime(dr, 21));
            user.FailedPasswordAnswerAttemptCount = dr.GetInt32(22);
            user.FailedPasswordAnswerAttemptWindowStart = LocaleHelper.ToLocalTime(NullableData.GetDateTime(dr, 23));
            user.Comment = NullableData.GetString(dr, 24);
            user.IsDirty = false;
        }
        ...
        private Int32 _ReferringAffiliateId;
        ...
        /// </summary>
        public Int32 ReferringAffiliateId
        {
            get { return this._ReferringAffiliateId; }
            set
            {
                if (this._ReferringAffiliateId != value)
                {
                    this._ReferringAffiliateId = value;
                    this.IsDirty = true;
                }
            }
        }
        ...
        protected SaveResult BaseSave()
        {
            if (this.IsDirty)
            {
                ...
                if (recordExists) {
                    ...
                    StringBuilder selectQuery = new StringBuilder();
                    selectQuery.Append("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT COUNT(1) As RecordCount FROM ac_Users");
                    selectQuery.Append(" WHERE UserId = @userId");
                ...
                if (recordExists)
                {
                    ...
                    updateQuery.Append(", ReferringAffiliateId = @ReferringAffiliateId");
                    ...
                    using (DbCommand updateCommand = database.GetSqlStringCommand(updateQuery.ToString()))
                    {
                        ...
                        database.AddInParameter(updateCommand, "@ReferringAffiliateId", System.Data.DbType.Int32, NullableData.DbNullify(this.ReferringAffiliateId));
                ...
                else
                {
                    ...
                    insertQuery.Append("INSERT INTO ac_Users (StoreId, UserName, LoweredUserName, Email, LoweredEmail, ReferringAffiliateId, AffiliateId, AffiliateReferralDate, PrimaryAddressId, PrimaryWishlistId, PayPalId, PasswordQuestion, PasswordAnswer, IsApproved, IsAnonymous, IsLockedOut, CreateDate, LastActivityDate, LastLoginDate, LastPasswordChangedDate, LastLockoutDate, FailedPasswordAttemptCount, FailedPasswordAttemptWindowStart, FailedPasswordAnswerAttemptCount, FailedPasswordAnswerAttemptWindowStart, Comment)");
                    insertQuery.Append(" VALUES (@StoreId, @UserName, @LoweredUserName, @Email, @LoweredEmail, @ReferringAffiliateId, @AffiliateId, @AffiliateReferralDate, @PrimaryAddressId, @PrimaryWishlistId, @PayPalId, @PasswordQuestion, @PasswordAnswer, @IsApproved, @IsAnonymous, @IsLockedOut, @CreateDate, @LastActivityDate, @LastLoginDate, @LastPasswordChangedDate, @LastLockoutDate, @FailedPasswordAttemptCount, @FailedPasswordAttemptWindowStart, @FailedPasswordAnswerAttemptCount, @FailedPasswordAnswerAttemptWindowStart, @Comment)");
                    ...
                    using (DbCommand insertCommand = database.GetSqlStringCommand(insertQuery.ToString()))
                    {
                        ...
                        database.AddInParameter(insertCommand, "@ReferringAffiliateId", System.Data.DbType.Int32, NullableData.DbNullify(this.ReferringAffiliateId));
