...
{
    /// <summary>
    /// Custom implementation of an ASP.NET Membership Provider for MakerShop
    /// </summary>
    public class MakerShopMembershipProvider : System.Web.Security.MembershipProvider
    {
        ...
        /// </summary>
        /// <remarks>MakerShop only supports a single application configured at "/".</remarks>
        ...
        /// <remarks>In MakerShop 7, this is equivalent to FindUsersByName because email address is always the username.</remarks>
        ...
        /// <remarks>This method is not implemented in MakerShop 7.</remarks>
        ...
        {
            WebTrace.Write("Initializing MakerShopMembershipProvider");
            if (config == null) throw new ArgumentNullException("config");
            if (string.IsNullOrEmpty(name)) name = "MakerShopMembershipProvider";
            config.Remove("name");
            if (string.IsNullOrEmpty(config["description"]))
            {
                config.Remove("description");
                config.Add("description", "A membership provider for the MakerShop application.");
            }
        ...
        {
            get { return "MakerShopMembershipProvider"; }
        }
        
        /// <summary>
        /// Gets the number of minutes in which a maximum number of invalid password or password-answer attempts are allowed before the membership user is locked out.
        /// </summary>
        /// <remarks>In MakerShop 7, invalid password attempt count does not reset after a specified time period.</remarks>
        ...
        /// </summary>
        /// <remarks>Regular expression validation for passwords is not supported in MakerShop 7.</remarks>
        ...
        /// </summary>
        /// <remarks>MakerShop 7 never requires a question and answer.</remarks>
        ...
        /// </summary>
        /// <remarks>MakerShop 7 (as of 7.2) does not requires a unique email.</remarks>
        ...
        /// <remarks>Password question and answer is not implemented in MakerShop 7.</remarks>
        /// <remarks>This method is not implemented in MakerShop 7.</remarks>
