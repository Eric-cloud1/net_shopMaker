...
namespace MakerShop.Users
{
    ...
    public partial class Address
    {
        ...
        public ShipZoneCollection ShipZones
        {
            get
            {
                if ((_ShipZones == null) || (_IsDirty))
                    _ShipZones = ShipZoneDataSource.LoadForAddress(this);
                return _ShipZones;
            }
        }
        ...
        public string ToString(string pattern, bool isHtml)
        {
            ...
            return MakerShop.Utility.AddressFormatter.Format(pattern, this.FullName, this.Company, this.Address1, this.Address2, this.City, this.Province, this.PostalCode, countryName, this.Phone, this.Fax, this.Email, isHtml);
        }
