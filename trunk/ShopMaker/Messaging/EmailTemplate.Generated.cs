...
#region Constructors
        ...
        public virtual void EnsureChildProperties()
        {
            ...
            if (this.TriggerCatalogsLoaded) { foreach (EmailTemplateTrigger_Catalog emailTemplateTrigger_Catalog in this.TriggerCatalogs) { emailTemplateTrigger_Catalog.EmailTemplateId = this.EmailTemplateId; } }
        }
...
#region Children
        ...
        private EmailTemplateTrigger_CatalogCollection _TriggerCatalogs;

        /// <summary>
        /// A collection of EmailTemplateTrigger objects associated with this EmailTemplate object.
        /// </summary>
        public EmailTemplateTrigger_CatalogCollection TriggerCatalogs
        {
            get
            {
                if (!this.TriggerCatalogsLoaded)
                {
                    this._TriggerCatalogs = EmailTemplateTrigger_CatalogDataSource.LoadForEmailTemplate(this.EmailTemplateId);
                }
                return this._TriggerCatalogs;
            }
        }
        [EditorBrowsable(EditorBrowsableState.Advanced)]
        internal bool TriggerCatalogsLoaded { get { return (this._TriggerCatalogs != null); } }
...
#region Associations
        ...
        protected SaveResult BaseSave()
        {
            if (this.IsDirty)
            {
                ...
                if (recordExists) {
                    ...
                    StringBuilder selectQuery = new StringBuilder();
                    selectQuery.Append("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT COUNT(1) As RecordCount FROM ac_EmailTemplates");
                    selectQuery.Append(" WHERE EmailTemplateId = @emailTemplateId");
        ...
        public virtual void SaveChildren()
        {
            ...
            if (this.TriggerCatalogsLoaded) this.TriggerCatalogs.Save();
        }
