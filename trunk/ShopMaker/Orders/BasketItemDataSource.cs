...
namespace MakerShop.Orders
{
    ...
    public partial class BasketItemDataSource
    {
        ...
        public static BasketItem CreateForProduct(int productId, short quantity, MakerShop.Payments.PaymentTypes paymentType)
        {
            return BasketItemDataSource.CreateForProduct(productId, quantity, string.Empty, String.Empty, Token.Instance.UserId, paymentType);
        }
        ...
        /// <returns>The BasketItem created</returns>
        public static BasketItem CreateForProduct(int productId, short quantity, string optionList, string kitList, MakerShop.Payments.PaymentTypes paymentType)
        {
            return BasketItemDataSource.CreateForProduct(productId, quantity, optionList, kitList, Token.Instance.UserId, paymentType);
        }
        ...
        /// <returns>The BasketItem created</returns>
        public static BasketItem CreateForProduct(int productId, short quantity, string optionList, string kitList, int userId, MakerShop.Payments.PaymentTypes paymentType)
        {
            // vALIDATE PARAMETERS
            ...
            ProductCalculator pcalc = ProductCalculator.LoadForProduct(productId, quantity, optionList, kitList, userId, paymentType);
            item.Sku = pcalc.Sku;
            ...
            item.OrderItemType = MakerShop.Orders.OrderItemType.Product;
