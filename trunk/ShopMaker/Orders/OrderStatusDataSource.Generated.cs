...
namespace MakerShop.Orders
{
    ...
    public partial class OrderStatusDataSource
    {
        ...
        public static int CountForCriteria(string sqlCriteria)
        {
            ...
            DbCommand selectCommand = database.GetSqlStringCommand("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT COUNT(1) AS TotalRecords FROM ac_OrderStatuses" + whereClause);
        ...
        {
            Database database = Token.Instance.Database;
            DbCommand selectCommand = database.GetSqlStringCommand("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT COUNT(1) AS TotalRecords FROM ac_OrderStatusEmails WHERE EmailTemplateId = @emailTemplateId");
        ...
        public static int CountForStore()
        {
            ...
            Database database = Token.Instance.Database;
            DbCommand selectCommand = database.GetSqlStringCommand("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT COUNT(1) AS TotalRecords FROM ac_OrderStatuses WHERE StoreId = @storeId");
        ...
        public static short GetNextOrderBy()
        {
            int storeId = Token.Instance.StoreId;
            Database database = Token.Instance.Database;
            using (DbCommand selectCommand = database.GetSqlStringCommand("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT (Max(OrderBy) + 1) AS NextOrderBy FROM ac_OrderStatuses WHERE StoreId = @storeId"))
            {
                database.AddInParameter(selectCommand, "@storeId", System.Data.DbType.Int32, storeId);
