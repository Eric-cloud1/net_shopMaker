...
namespace MakerShop.Orders
{
    ...
    public partial class TrackingNumberDataSource
    {
        ...
        public static int CountForCriteria(string sqlCriteria)
        {
            ...
            DbCommand selectCommand = database.GetSqlStringCommand("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT COUNT(1) AS TotalRecords FROM ac_TrackingNumbers" + whereClause);
        ...
        {
            Database database = Token.Instance.Database;
            DbCommand selectCommand = database.GetSqlStringCommand("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT COUNT(1) AS TotalRecords FROM ac_TrackingNumbers WHERE OrderShipmentId = @orderShipmentId");
        ...
        {
            Database database = Token.Instance.Database;
            DbCommand selectCommand = database.GetSqlStringCommand("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT COUNT(1) AS TotalRecords FROM ac_TrackingNumbers WHERE ShipGatewayId = @shipGatewayId");
