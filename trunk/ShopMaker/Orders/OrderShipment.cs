...
namespace MakerShop.Orders
{
    ...
    public partial class OrderShipment : IShipment
    {
        ...
        /// ShipToMiddleName
        /// </summary>  
        private String _ShipToMiddleName = string.Empty;
        public String ShipToMiddleName
        {
            get
            {
                Order_Ex ex = new Order_Ex();
                bool isDetails = ex.Load(this.OrderId);

                if (isDetails == true)
                    return ex.BillToMiddleName;
        ...
        {
            //string name = (this.ShipToFirstName + " " + this.ShipToMiddleName + " " +this.ShipToLastName).Trim();
