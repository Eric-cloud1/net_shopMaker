        ...
        public static List<CmsPathNode> GetCmsPath(int categoryId, int currentNodeId, CatalogNodeType currentNodeType)
        {
            ...
            switch (currentNodeType)
            {
                case CatalogNodeType.Category :
                    selectQuery.Append("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT CP.ParentId AS NodeId, 0 As NodeType, C.Name, C.Summary, CP.ParentLevel, CP.ParentNumber");
