...
namespace MakerShop.Catalog
{
    ...
    public class CatalogPathNode : CatalogNode
    {
        ...
        new private bool IsDirty { get { throw new MakerShop.Exceptions.MakerShopException("unsupported"); } }
        new private int OrderBy { get { throw new MakerShop.Exceptions.MakerShopException("unsupported"); } }

        new private MakerShop.Common.SaveResult Save()
        {
            throw new MakerShop.Exceptions.MakerShopException("CatalogPathNode is a read-only object.");
        }
