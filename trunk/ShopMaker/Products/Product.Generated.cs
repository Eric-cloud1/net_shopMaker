...
#region Constructors
        ...
        public static string GetColumnNames(string prefix)
        {
          ...
          columnNames.Add(prefix + "IsNotValidated");
          columnNames.Add(prefix + "CustomerServiceUrl");
        ...
        public static void LoadDataReader(Product product, IDataReader dr)
        {
            ...
            product.IsNotValidated = dr.GetBoolean(50);
            product.CustomerServiceUrl = NullableData.GetString(dr, 51); 
        ...
        private Boolean _IsNotValidated;
        ...
        {
            get { return this._CustomerServiceUrl; }
            set
            {
                if (this._CustomerServiceUrl != value)
                {
                    this._CustomerServiceUrl = value;
                    this.IsDirty = true;
                }
            }
        }
        ...
        {
            get { return this._IsNotValidated; }
            set
            {
                if (this._IsNotValidated != value)
                {
                    this._IsNotValidated = value;
                    this.IsDirty = true;
                }
            }
        }
...
#region Children
        ...
        /// <summary>
        /// The Plan Downsells object associated with this Product
        /// </summary>
        /// 
        private SubscriptionPlanDownsellsCollection _SubscriptionPlanDownsellsCollection;
        public SubscriptionPlanDownsellsCollection SubscriptionPlanDownsellsCollection
        {
            get
            {
                if (!this.SubscriptionPlanDownsellsCollectionLoaded)
                {
                    this._SubscriptionPlanDownsellsCollection = SubscriptionPlanDownsellsDataSource.LoadByProductId(this.ProductId);
                }
                return this._SubscriptionPlanDownsellsCollection;
            }
        }

        [EditorBrowsable(EditorBrowsableState.Advanced)]
        internal bool SubscriptionPlanDownsellsCollectionLoaded { get { return (this._SubscriptionPlanDownsellsCollection != null); } }


        /// <summary>
        /// The SubscriptionPlanDetails object associated with this Product
        /// </summary>
        /// 
        private SubscriptionPlanDetailsCollection _SubscriptionPlanDetails;
        public SubscriptionPlanDetailsCollection SubscriptionPlanDetails
        {
            get
            {
                if (!this.SubscriptionPlanDetailsLoaded)
                {
                    this._SubscriptionPlanDetails = SubscriptionPlanDetailsDataSource.LoadByProductId(ProductId);
                }
                return this._SubscriptionPlanDetails;
            }
        }

        [EditorBrowsable(EditorBrowsableState.Advanced)]
        internal bool SubscriptionPlanDetailsLoaded { get { return (this._SubscriptionPlanDetails != null); } }
         ...
         /// <summary>
        /// The gatewayTemplate object associated with this Product
        /// </summary>
        /// 
        private Payments.PaymentGatewayTemplate_Product _PaymentGatewayTemplate_Product;
        public Payments.PaymentGatewayTemplate_Product PaymentGatewayTemplate_Product
        {
            get
            {
                if (!this.PaymentGatewayTemplate_ProductLoaded)
                {
                    this._PaymentGatewayTemplate_Product = Payments.PaymentGatewayTemplate_ProductDataSource.Load(this.ProductId);
                }
                return this._PaymentGatewayTemplate_Product;
            }
        }

        [EditorBrowsable(EditorBrowsableState.Advanced)]
        internal bool PaymentGatewayTemplate_ProductLoaded { get { return (this._PaymentGatewayTemplate_Product != null); } }
...
#region Associations
        ...
        protected SaveResult BaseSave()
        {
            if (this.IsDirty)
            {
                ...
                if (recordExists) {
                    ...
                    StringBuilder selectQuery = new StringBuilder();
                    selectQuery.Append("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT COUNT(1) As RecordCount FROM ac_Products");
                    selectQuery.Append(" WHERE ProductId = @productId");
                ...
                if (recordExists)
                {
                    ...
                    updateQuery.Append(", IsNotValidated = @IsNotValidated");
                    updateQuery.Append(", CustomerServiceUrl = @CustomerServiceUrl");
                    ...
                    using (DbCommand updateCommand = database.GetSqlStringCommand(updateQuery.ToString()))
                    {
                        ...
                        database.AddInParameter(updateCommand, "@IsNotValidated", System.Data.DbType.Boolean, this.IsNotValidated);
                        database.AddInParameter(updateCommand, "@CustomerServiceUrl", System.Data.DbType.String, this.CustomerServiceUrl);
                ...
                else
                {
                    ...
                    using (DbCommand insertCommand = database.GetSqlStringCommand(insertQuery.ToString()))
                    {
                        ...
                        database.AddInParameter(insertCommand, "@IsNotValidated", System.Data.DbType.Boolean, this.IsNotValidated);
                        database.AddInParameter(insertCommand, "@CustomerServiceUrl", System.Data.DbType.String, this.CustomerServiceUrl);
        ...
        public virtual void SaveChildren()
        {
            ...
            if (this.SubscriptionPlanDownsellsCollectionLoaded) this.SubscriptionPlanDownsellsCollection.Save();
            if (this.PaymentGatewayTemplate_ProductLoaded) this.PaymentGatewayTemplate_Product.Save();
        }
