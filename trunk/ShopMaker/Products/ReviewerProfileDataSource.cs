...
namespace MakerShop.Products
{
    ...
    public partial class ReviewerProfileDataSource
    {
        ...
        public static ReviewerProfile LoadForEmail(string emailAddress)
        {
            ...
            selectQuery.Append("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT " + ReviewerProfile.GetColumnNames(string.Empty));
        ...
        public static string GetEmail(int reviewerProfileId)
        {
            ...
            Database database = Token.Instance.Database;
            DbCommand selectCommand = database.GetSqlStringCommand("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT Email FROM ac_ReviewerProfiles WHERE ReviewerProfileId = @id");
