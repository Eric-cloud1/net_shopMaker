...
namespace MakerShop.Products
{
    ...
    public partial class ProductKitComponentDataSource
    {
        ...
        public static ProductKitComponent Load(Int32 productId, Int32 kitComponentId)
        {
            ...
            selectQuery.Append("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT " + ProductKitComponent.GetColumnNames(string.Empty));
        ...
        {
            Database database = Token.Instance.Database;
            using (DbCommand selectCommand = database.GetSqlStringCommand("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT (Max(OrderBy) + 1) AS NextOrderBy FROM ac_ProductKitComponents WHERE ProductId = @productId"))
            {
                database.AddInParameter(selectCommand, "@productId", System.Data.DbType.Int32, productId);
