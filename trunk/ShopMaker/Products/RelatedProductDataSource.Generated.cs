...
namespace MakerShop.Products
{
    ...
    public partial class RelatedProductDataSource
    {
        ...
        public static RelatedProduct Load(Int32 productId, Int32 childProductId)
        {
            ...
            selectQuery.Append("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT " + RelatedProduct.GetColumnNames(string.Empty));
        ...
        {
            Database database = Token.Instance.Database;
            using (DbCommand selectCommand = database.GetSqlStringCommand("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT (Max(OrderBy) + 1) AS NextOrderBy FROM ac_RelatedProducts WHERE ProductId = @productId"))
            {
                database.AddInParameter(selectCommand, "@productId", System.Data.DbType.Int32, productId);
