...
namespace MakerShop.Products
{
    ...
    public class ProductCalculator
    {
        ...
        private MakerShop.Payments.PaymentTypes _PaymentType;
        /// <summary>
        /// Id of the product
        /// </summary>
        ...
        private ProductCalculator(int productId, short quantity, string optionList, string kitList, int userId, bool calculateTax, MakerShop.Payments.PaymentTypes paymentType)
        {
        ...
        {
            SubscriptionPlanDetails InitialSubscription = SubscriptionPlanDetailsDataSource.Load(_ProductId, _PaymentType);
            if (InitialSubscription == null)
                return 0;
            // maybe can figure out subscription # by the order history.
            LSDecimal basePrice = InitialSubscription.PaymentAmount;
        ...
        public static ProductCalculator LoadForProduct(int productId, short quantity, string optionList, List<int> kitList, MakerShop.Payments.PaymentTypes paymentType)
        {
            return LoadForProduct(productId, quantity, optionList, AlwaysConvert.ToList(",", kitList), Token.Instance.UserId, false,paymentType);
        }
        ...
        /// <returns>A ProductCalculator object</returns>
        public static ProductCalculator LoadForProduct(int productId, short quantity, string optionList, string kitList, MakerShop.Payments.PaymentTypes paymentType)
        {
            return LoadForProduct(productId, quantity, optionList, kitList, Token.Instance.UserId, false, paymentType);
        }
        ...
        /// <param name="userId">User Id</param>
        /// <returns>A ProductCalculator object</returns>
        public static ProductCalculator LoadForProduct(int productId, short quantity, string optionList, string kitList, int userId, MakerShop.Payments.PaymentTypes paymentType)
        {
            return LoadForProduct(productId, quantity, optionList, kitList, userId, false,paymentType);
        }
        ...
        /// the shopping price inclusive of tax.</param>
        /// <returns>A ProductCalculator object</returns>
        public static ProductCalculator LoadForProduct(int productId, short quantity, string optionList, string kitList, int userId, bool calculateTax, MakerShop.Payments.PaymentTypes paymentType)
        {
            string key = typeof(ProductCalculator).ToString() + GenerateHash(productId, quantity, optionList, kitList, userId, calculateTax,paymentType);
            ProductCalculator cachedItem = ContextCache.GetObject(key) as ProductCalculator;
            if (cachedItem != null) return cachedItem;
            cachedItem = new ProductCalculator(productId, quantity, optionList, kitList, userId, calculateTax, paymentType);
        ...
        private static string GenerateHash(int productId, short quantity, string optionList, string kitList, int userId, bool calculateTax, MakerShop.Payments.PaymentTypes paymentType)
        {
            ...
            paramValues.Append(paymentType);
