...
namespace MakerShop.Products
{
    ...
    public partial class ProductOptionDataSource
    {
        ...
        public static ProductOption Load(Int32 productId, Int32 optionId)
        {
            ...
            selectQuery.Append("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT " + ProductOption.GetColumnNames(string.Empty));
        ...
        {
            Database database = Token.Instance.Database;
            using (DbCommand selectCommand = database.GetSqlStringCommand("SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED; SELECT (Max(OrderBy) + 1) AS NextOrderBy FROM ac_ProductOptions WHERE ProductId = @productId"))
            {
                database.AddInParameter(selectCommand, "@productId", System.Data.DbType.Int32, productId);
