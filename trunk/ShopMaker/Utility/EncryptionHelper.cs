...
namespace MakerShop.Utility
{
    ...
    public static class EncryptionHelper
    {
        ...
        {
            //GET THE MakerShop SETTINGS
            //IF CONFIG IS NULL, WE DO NOT HAVE AN "UPDATABLE" SECTION
            System.Configuration.Configuration updateableConfig = null;
            MakerShopEncryptionSection encryptionSection = null;
            try
            {
                encryptionSection = MakerShopEncryptionSection.GetUpdatableSection(out updateableConfig);
            }
            catch { }
            if (encryptionSection == null) encryptionSection = MakerShopEncryptionSection.GetSection();
            ...
            //SAVE SETTINGS
            MakerShopEncryptionSection.UpdateConfig(updateableConfig, encryptionSection);
        ...
        /// <summary>
        /// Gets the encryption key from MakerShop settings
        /// </summary>
        ...
        public static byte[] GetBackupKey(int partNumber)
        {
            ...
            if (!Token.Instance.User.IsInRole(MakerShop.Users.Role.SystemAdminRoles))
            {
