...
TagPrefix="cb" %> <%--
<DisplayPage>
  <Name>Category Grid (Shallow Item Display)</Name>
  <NodeType>Category</NodeType>
  <Description
    >Displays products for only the selected category. Items are displayed in a
    grid format with breadcrumb links, sorting, page navigation, and
    sub-category link options.</Description
  >
</DisplayPage>
--%>
<script runat="server">
