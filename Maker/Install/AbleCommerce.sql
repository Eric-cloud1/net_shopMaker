...
create table "ac_WishlistItems" ( 
	...
	"Comment" nvarchar(max) null) ON 'PRIMARY'  
...
create table "ac_WishlistItemInputs" ( 
	...
	"InputValue" nvarchar(max) not null) ON 'PRIMARY'  
...
create table "ac_UserSettings" ( 
	...
	"FieldValue" nvarchar(max) not null) ON 'PRIMARY'  
...
create table "ac_OrderItems" ( 
	...
	"KitList" varchar(255) null,
	"CustomFields" nvarchar(max) null) ON 'PRIMARY'  
...
create table "ac_OrderItemDigitalGoods" ( 
	...
	"SerialKeyData" nvarchar(max) null) ON 'PRIMARY'  
...
create table "ac_SerialKeys" ( 
	...
	"DigitalGoodId" int not null,
	"SerialKeyData" nvarchar(max) not null) ON 'PRIMARY'  
