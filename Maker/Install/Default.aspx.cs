...
public partial class Install_Default : System.Web.UI.Page
{
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        string acVersion = MakerShopVersion.Instance.Version;
        Page.Title = string.Format(Page.Title, acVersion);
        Heading.InnerText = string.Format(Heading.InnerText, acVersion);
    }
    
    protected void AcceptButton_Click(object sender, EventArgs e)
    {
        Response.Redirect("Configure1.aspx");
    }
    ...
    private bool TestPermissions(List<string> messages)
    {
        ...
        string[] testFiles = new string[15];
        ...
        testFiles[9] = Server.MapPath("~/App_Data/Scriptlets/Custom/Content/DELETEME.TXT");
        testFiles[10] = Server.MapPath("~/App_Data/Scriptlets/Custom/Footer/DELETEME.TXT");
        testFiles[11] = Server.MapPath("~/App_Data/Scriptlets/Custom/Header/DELETEME.TXT");
        testFiles[12] = Server.MapPath("~/App_Data/Scriptlets/Custom/Layout/DELETEME.TXT");
        testFiles[13] = Server.MapPath("~/App_Data/Scriptlets/Custom/Sidebar/DELETEME.TXT");
        testFiles[14] = Server.MapPath("~/App_Data/Feeds/DELETEME.TXT");
