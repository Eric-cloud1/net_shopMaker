<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PopularProductsDialog.ascx.cs" Inherits="Webparts_PopularProductsDialog" %>
<%--
<conlib>
...
<div class="section">
    ...
    <div class="content"> 
    <asp:DataList ID="ProductList" runat="server" OnItemDataBound="ProductList_ItemDataBound" OnItemCommand="ProductList_ItemCommand"  Width="100%" AlternatingItemStyle-CssClass="ProductItemViewOdd"
        SeparatorStyle-CssClass="itemSeparator" ItemStyle-VerticalAlign="bottom">                     
            <ItemStyle HorizontalAlign="center" VerticalAlign="bottom" CssClass="ProductItemView"/>            
            <ItemTemplate>
                ...
                <tr>
                    <td align="center" valign="top" class="thumbnail">
		                ...
		                <p class="detailsInnerPara">
		                    <a href="<%# Page.ResolveClientUrl(Eval("NavigateUrl").ToString()) %>"><%#Eval("Name")%></a><br />
					    ...
					    <div style="margin-top:10px"><uc:AddToCartLink ID="Add2Cart" runat="server" ProductId='<%#Eval("ProductId")%>' /></div><br />
                    </td>
                </tr>
            </table>
        </ItemTemplate>
