<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OrderItemDetail.ascx.cs" Inherits="ConLib_Utility_OrderItemDetail" %>
<%-- 
<conlib>
...
--%>
<asp:HyperLink ID="ProductLink" runat="Server" SkinID="OrderProductLink" NavigateUrl="" />
...
<asp:Label ID="WishlistLabel" runat="Server" Text="<br/>from {0}&#39;s Wish List" SkinID="NoteText"></asp:Label>
