...
public partial class ConLib_Utility_OrderItemDetail : System.Web.UI.UserControl
{
    ...
    protected void Page_PreRender(object sender, EventArgs e)
    {
        if (_OrderItem != null)
        {
            ...
            if (product != null)
            {
                ...
                {
                    ProductLink.NavigateUrl = UrlGenerator.GetBrowseUrl(product.ProductId, CatalogNodeType.Product, productName);
