...
Inherits="MakerShop.Web.UI.MakerShopPage" Title="Category Details" %> <%@
Register Assembly="MakerShop.Web"
Namespace="MakerShop.Web.UI.WebControls.WebParts" TagPrefix="cb" %> <%--
<DisplayPage>
  <Name>Category Details Page</Name>
  <NodeType>Category</NodeType>
  <Description
    >Displays categories, products, webpages, and links for only the selected
    category. Items are displayed in a left-aligned, row format, with
    descriptions and images.</Description
  >
</DisplayPage>
--%>
<script runat="server">
