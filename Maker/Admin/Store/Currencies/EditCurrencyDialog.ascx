<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditCurrencyDialog.ascx.cs" Inherits="Admin_Store_Currencies_EditCurrencyDialog" EnableViewState="true" %>
...
<ajax:UpdatePanel ID="EditCurrencyAjax" runat="server" UpdateMode="Conditional">
    ...
    <asp:Panel ID="EditPanel" runat="server" Style="display:none;width:450px" CssClass="modalPopup">
        ...
        <table cellpadding="4" cellspacing="0" class="inputForm">
            <tr>
                <td colspan="4" class="validation" align="center">
                    <asp:Label ID="AddedMessage" runat="server" SkinID="GoodCondition" EnableViewState="false" Visible="false" Text="Currency {0} added."></asp:Label>
                    <asp:ValidationSummary ID="ValidationSummary1" runat="server" ValidationGroup="EditCurrency" />
                </td>
            </tr>
            <tr>
                ...
                <td colspan="3">
                    ...
                    <asp:RequiredFieldValidator ID="NameValidator" runat="server" ControlToValidate="Name"
                        Display="Static" ErrorMessage="Name is required." ValidationGroup="EditCurrency" Text="*"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <th class="rowHeader" nowrap>
                ...
                <td nowrap>
                    ...
                    <asp:RequiredFieldValidator ID="ISOCodeValidator" runat="server" ControlToValidate="ISOCode"
                        Display="Static" ErrorMessage="ISO code is required." ValidationGroup="EditCurrency" Text="*"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="ISOCodeValidator2" runat="server" ControlToValidate="ISOCode"
                        Display="Static" ErrorMessage="ISO code must be three letters." ValidationGroup="EditCurrency" Text="*"
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    <asp:RequiredFieldValidator ID="CurrencySymbolValidator" runat="server" ControlToValidate="CurrencySymbol"
                        Display="Static" ErrorMessage="Currency symbol is required." ValidationGroup="EditCurrency" Text="*"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr id="trExchangeRate1" runat="server">
                <td align="right">
            ...
            <tr id="trExchangeRate2" runat="server">
            ...
            <tr id="trDisplayOptions4a" runat="server" visible="false">
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="DecimalDigitsValidator" runat="server" ControlToValidate="DecimalDigits"
                        Display="Static" ErrorMessage="Deicmal digits is required." ValidationGroup="EditCurrency" Text="*"></asp:RequiredFieldValidator>
                    <asp:RangeValidator ID="DecimalDigitsValidator2" runat="server" ControlToValidate="DecimalDigits"
                        Display="Static" ErrorMessage="Decimal digits must be a number between 0 and 9." ValidationGroup="EditCurrency" Text="*"
            ...
            <tr id="trDisplayOptions5" runat="server" visible="false">
                ...
                <td colspan="3">
                    ...
                    <asp:RequiredFieldValidator ID="GroupSizesValidator" runat="server" ControlToValidate="GroupSizes"
                        Display="Static" ErrorMessage="Group size is required." ValidationGroup="EditCurrency" Text="*"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="GroupSizesValidator2" runat="server" ControlToValidate="GroupSizes"
                        Display="Static" ErrorMessage="Group size can only be a comma delimited list of integers in the format of #(,#)" ValidationGroup="EditCurrency" Text="*"
            ...
            <tr>
                <td>&nbsp;</td>
                <td colspan="3">
                    <asp:Button ID="SaveButton" runat="server" Text="Save" OnClick="SaveButton_Click" ValidationGroup="EditCurrency" />
        ...
        <wwh:wwHoverPanel ID="CCHoverLookupPanel2"
            runat="server" 
