...
CodeFile="EditSpecial.aspx.cs" Inherits="Admin_Products_Specials_EditSpecial"
Title="Edit Pricing Rule" %> <%@ Register
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <p align="justify">
    ...
    <asp:Localize
      ID="InstructionText"
      runat="server"
      Text="Only price is required.  You can optionally restrict the price by date or group."
    ></asp:Localize>
  </p>
    ...
    <tr>
      ...
      <td>
        ...
        <asp:RangeValidator
          ...
          runat="server"
          Text="*"
          ErrorMessage="Special Price must be between 0 and 99999999.99"
          MinimumValue="0"
        ...
        <asp:Label
          ID="BasePriceMessage"
          runat="server"
          Text="(must be less than base price of {0:lc})"
        ></asp:Label>
      </td>
    </tr>
    <tr>
