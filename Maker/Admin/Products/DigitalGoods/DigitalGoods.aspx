...
<ajax:UpdatePanel runat="server" ID="VariantPanel" UpdateMode="Always">
    <ContentTemplate>
        ...
        <div class="pageContent">
                            <asp:Label ID="SavedMessage" runat="server" Text="Digital Goods updated at {0:t}"
        ...
        <asp:GridView ID="DigitalGoodsGrid" runat="server" AutoGenerateColumns="False" 
            ...
            onrowdatabound="DigitalGoodsGrid_RowDataBound">
            <Columns>
                <asp:TemplateField HeaderText="Name">
                 ...
                 <asp:TemplateField HeaderText="Size">
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate>
                          <asp:DropDownList runat="server" ID="PaymentTypes" RepeatDirection="Horizontal">
                  ...
                  <asp:TemplateField HeaderText="Payment Status">
                    <ItemStyle HorizontalAlign="Center" Width="100px" />
                    <ItemTemplate>
                             <asp:DropDownList runat="server" ID="PaymentStatus" RepeatDirection="Horizontal">
                             <asp:ListItem Text="-- SELECT --" Value="0" />
                                                   <asp:ListItem Text="Authorized" Value="2" />
                                                    <asp:ListItem Text="Captured" Value="5" />
                                                </asp:DropDownList>
                    </ItemTemplate>
                </asp:TemplateField>             
                <asp:TemplateField>
