...
CodeFile="Default.aspx.cs" Inherits="Admin_Products_Reviews_Default"
Title="Manage Reviews" EnableViewState="false" %> <%@ Register
        ...
        <ajax:UpdatePanel ID="ReviewAjax" runat="server">
          <ContentTemplate>
              ...
              <div class="content">
                <table class="inputForm">
                  <tr>
                    <th class="rowHeader">
                      <cb:ToolTipLabel
                        ID="ShowApprovedLabel"
                        runat="server"
                        Text="Approval Status:"
                        AssociatedControlId="ShowApproved"
                        ToolTip="Indicate whether the result should include reviews that are approved, unapproved or both."
                      />
                    </th>
                    <td>
            ...
            <cb:SortedGridView
              ...
              DataSourceID="ProductReviewDs"
              ShowFooter="False"
              DefaultSortExpression="Name"
              SkinID="PagedList"
              Width="100%"
              OnDataBound="ReviewGrid_DataBound"
            >
              <Columns>
                ...
                <asp:TemplateField HeaderText="Product" SortExpression="P.Name">
                  ...
                  <ItemTemplate>
                    <asp:HyperLink
                      ID="Product"
                      runat="server"
                      NavigateUrl='<%# Eval("ProductId", "../EditProduct.aspx?ProductId={0}") %>'
                ...
                >
                  ...
                  <ItemTemplate>
                    <asp:Label
                      ID="ReviewerEmail"
                      runat="server"
                      Text='<%# Eval("ReviewerProfile.Email") %>'
                    ></asp:Label>
                    <asp:Label
                      ID="ReviewerEmailVerified"
                      runat="server"
                      Visible='<%# Eval("ReviewerProfile.EmailVerified") %>'
                      Text=" (verified)"
                    ></asp:Label
                    ><br />
                    <asp:Label
                      ID="ReviewerName"
                      runat="server"
                      Text='<%# Eval("ReviewerProfile.DisplayName", "{0}") %>'
                    ></asp:Label>
                    <asp:Label
                      ID="ReviewerLocation"
                      runat="server"
                      Visible='<%# !string.IsNullOrEmpty(Eval("ReviewerProfile.Location").ToString()) %>'
                      Text='<%# Eval("ReviewerProfile.Location", " from {0}") %>'
                    ></asp:Label>
                  </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Rating" SortExpression="Rating">
                  ...
                  <ItemTemplate>
                    <asp:Image
                      ID="Rating"
                      runat="server"
                      ImageUrl='<%# NavigationHelper.GetRatingImage(AlwaysConvert.ToDecimal(Eval("Rating")))%>'
                      AlternateText='<%# Eval("Rating") %>'
                    ></asp:Image>
                  </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField
                ...
                >
                  ...
                  <ItemTemplate>
                    ...
                    <asp:Label
                      ID="ReviewTitle"
                      runat="server"
                      Text='<%# Eval("ReviewTitle") %>'
                    ></asp:Label
                    ><br /><br />
                    <asp:Label
                      ID="ReviewBody"
                      runat="server"
                      Text='<%#"<pre class=Reviews>" +  Eval("ReviewBody")+ "</pre>" %>'
                    ></asp:Label>
                  </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                  ...
                  <ItemTemplate>
                    <asp:HyperLink
                      ID="EditLink"
                      runat="server"
                      NavigateUrl='<%# Eval("ProductReviewId", "EditReview.aspx?ReviewId={0}") %>'
                      ><asp:Image
                        ID="EditIcon"
                        runat="server"
                        SkinID="EditIcon"
              ...
              <EmptyDataTemplate>
                <asp:Label
                  ID="EmptyDataText"
                  runat="server"
                  Text="No matching reviews found."
                ></asp:Label>
              </EmptyDataTemplate>
            </cb:SortedGridView>
            ...
            <asp:ObjectDataSource
              ...
              DataObjectTypeName="MakerShop.Products.ProductReview"
              DeleteMethod="Delete"
              EnablePaging="true"
            >
              <SelectParameters>
                <asp:ControlParameter
                  Name="productId"
                  ControlID="HiddenProductId"
                  PropertyName="Value"
                  Type="Int32"
                />
                <asp:ControlParameter
                  Name="approved"
                  ControlID="ShowApproved"
                ...
                <tr>
                  <th class="rowHeader">
                    <cb:ToolTipLabel
                      ...
                      runat="server"
                      Text="Selected Reviews:"
                      AssociatedControlId="ReviewAction"
                      ToolTip="Select an action to take with the selected reviews."
                    />
                  </th>
                  <td>
