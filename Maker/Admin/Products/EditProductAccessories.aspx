...
CodeFile="EditProductAccessories.aspx.cs"
Inherits="Admin_Products_EditProductAccessories" Title="Product Accessories" %>
    ...
    <div class="caption">
      <h1>
        <asp:Localize
          ID="Caption"
          runat="server"
          Text="Product Accessories for '{0}'"
        ></asp:Localize>
      </h1>
    </div>
  </div>
      ...
      <td width="100%">
        <p align="justify">
          <asp:Literal
            ID="InstructionText"
            runat="server"
            Text="Select the products that are upsell, that should be highlighted in up-selling scenarios."
          ></asp:Literal>
        </p>
      </td>
    </tr>
        ...
        >
          <ContentTemplate>
                    ...
                    <asp:TemplateField HeaderText="Item" SortExpression="Name">
                      ...
                      <ItemTemplate>
                        <asp:HyperLink
                          ...
                          runat="server"
                          Text='<%#Eval("Name")%>'
                          NavigateUrl='<%#String.Format("~/Admin/Products/EditProduct.aspx?ProductId={0}",Eval("ProductId")) %>'
                          SkinID="FieldHeader"
                        /><br />
                      </ItemTemplate>
                    </asp:TemplateField>
            ...
            <div class="section">
              ...
              <div class="content">
                <asp:GridView
                  ID="UpsellProductGrid"
                  runat="server"
                  AutoGenerateColumns="False"
                  DataSourceID="UpsellProductsDs"
                  DataKeyNames="ChildProductId"
                  ShowHeader="False"
                  Width="100%"
                  GridLines="Both"
                  SkinID="PagedList"
                  OnRowCommand="UpsellProductGrid_RowCommand"
                  OnRowDeleting="UpsellProductGrid_RowDeleting"
                >
                  <Columns>
                ...
                <asp:ObjectDataSource
                  ...
                  TypeName="MakerShop.Products.UpsellProductDataSource"
                >
                  <SelectParameters>
