...
CodeFile="Search.aspx.cs" Inherits="Admin_Products_Kits_Search" Title="Manage
Kits" %> <%@ Register Assembly="MakerShop.Web"
    ...
    <tr>
      <td style="padding: 10px 0px 10px 0px; text-indent: 20px">
        <asp:Label
          ID="InstructionText"
          runat="server"
          Text="Enter all or part of a kit name.  Wildcard characters * and ? are accepted.  You can also leave the name field empty to show all."
        ></asp:Label>
      </td>
    </tr>
    <tr>
      <td class="itemList">
                  ...
                  >
                      ...
                      >
                        ...
                        <ItemTemplate>
                          <asp:HyperLink
                            ...
                            runat="server"
                            Text='<%#Eval("Name")%>'
                            NavigateUrl='<%#Eval("ProductId", "EditKit.aspx?ProductId={0}")%>'
                          />
                        </ItemTemplate>
                      </asp:TemplateField>
                      <asp:TemplateField HeaderText="Components">
                        ...
                        <ItemTemplate>
                          <asp:Label
                            ID="Components"
                            runat="server"
                            Text='<%#Eval("ProductKitComponents.Count")%>'
                          />
                        </ItemTemplate>
                      </asp:TemplateField>
                    </Columns>
                    <EmptyDataTemplate>
                      <asp:Label
                        ID="EmptyMessage"
                        runat="server"
                        Text="There are no kits that match the search text."
                      ></asp:Label>
                    </EmptyDataTemplate>
                  </cb:SortedGridView>
                </td>
        ...
        <asp:ObjectDataSource
          ...
          TypeName="MakerShop.Products.KitDataSource"
        >
          <SelectParameters>
