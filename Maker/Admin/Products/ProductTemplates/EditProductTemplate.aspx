    ...
    <table cellpadding="2" cellspacing="0" class="innerLayout">
        ...
        <tr>
            <td>
                ...
                <asp:ObjectDataSource ID="MerchantFieldDs" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="LoadForProductTemplate" TypeName="MakerShop.Products.InputFieldDataSource"
                 SortParameterName="sortExpression" DataObjectTypeName="MakerShop.Products.InputField" DeleteMethod="Delete">
                    <SelectParameters>
        ...
        <tr>
            <td>
                ...
                <asp:ObjectDataSource ID="CustomerFieldDs" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="LoadForProductTemplate" TypeName="MakerShop.Products.InputFieldDataSource"
                 SortParameterName="sortExpression" DataObjectTypeName="MakerShop.Products.InputField" DeleteMethod="Delete">
                    <SelectParameters>
