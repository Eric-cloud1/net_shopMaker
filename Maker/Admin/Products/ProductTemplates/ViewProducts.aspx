...
Inherits="Admin_Products_ProductTemplates_ViewProducts" Title="Assigned
Products" %> <%@ Register Assembly="MakerShop.Web"
    ...
    <tr>
      <td valign="top" style="width: 50%">
        <div class="section">
          ...
          <div class="content">
            <asp:GridView
              ID="AssociatedProductGrid"
              runat="server"
              AutoGenerateColumns="False"
              DataSourceID="AssociatedProductsDs"
              ...
              GridLines="Both"
              SkinID="PagedList"
              OnRowDeleting="AssociatedProductGrid_RowDeleting"
            >
              <Columns>
              ...
              <EmptyDataTemplate>
                <asp:Label
                  ID="EmptyMessage"
                  runat="server"
                  Text="There are no products associated with this product template."
                ></asp:Label>
              </EmptyDataTemplate>
            </asp:GridView>
            <asp:ObjectDataSource
              ID="AssociatedProductsDs"
              runat="server"
              OldValuesParameterFormatString="original_{0}"
              SelectMethod="LoadForProductTemplate"
              TypeName="MakerShop.Products.ProductDataSource"
            >
              <SelectParameters>
                <asp:QueryStringParameter
                  Name="ProductTemplateId"
                  QueryStringField="ProductTemplateId"
                  Type="Object"
                />
              </SelectParameters>
            </asp:ObjectDataSource>
      ...
      <td valign="top">
        <div class="section">
          <div class="header">
            <h2 class="findfeatured">
              <asp:Localize
                ID="FindProductsCaption"
                runat="server"
                Text="Find and Assign Products"
              ></asp:Localize>
            </h2>
          </div>
          <asp:Panel
                ...
                <asp:TemplateField HeaderText="Link">
                  ...
                  <itemtemplate>
                    <asp:ImageButton
                      ...
                      AlternateText="Add"
                      ToolTip="Associate with this product template"
                      SkinId="AddIcon"
                    ...
                    <asp:ImageButton
                      ...
                      CommandArgument="<%#Container.DataItemIndex%>"
                      AlternateText="Remove"
                      ToolTip="Unlink from this product template"
                      SkinId="DeleteIcon"
                      OnClientClick="this.visible=false"
