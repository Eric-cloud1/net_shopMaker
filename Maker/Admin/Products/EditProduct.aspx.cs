...
public partial class Admin_Products_EditProduct : MakerShop.Web.UI.MakerShopAdminPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            IsNotValidated.Checked = _Product.IsNotValidated;
            CustomerServiceUrl.Text = _Product.CustomerServiceUrl;
    ...
    public void SaveButton_Click(object sender, EventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            ...
            _Product.IsNotValidated = IsNotValidated.Checked;
            _Product.CustomerServiceUrl = CustomerServiceUrl.Text ;
    ...
    {
        MakerShop.UI.Styles.Theme[] themes = StoreDataHelper.GetStoreThemes();
