...
public partial class Admin_Products_Variants_Options : MakerShop.Web.UI.MakerShopAdminPage
{
    int _ProductId = 0;
    Product _Product;
    ...
    protected string GetEditOptionUrl(object dataItem)
    {
        ...
        return Page.ResolveClientUrl("~/Admin/Products/Variants/EditOption.aspx?ProductId=" + _ProductId.ToString() + "&OptionId=" + o.OptionId.ToString());
    }
}