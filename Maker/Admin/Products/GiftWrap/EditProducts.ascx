                                ...
                                <div class="section">
                                    ...
                                    <div class="content">
                                        <asp:GridView ID="RelatedProductGrid" runat="server" AutoGenerateColumns="False"
                                            ...
                                            Width="100%" GridLines="Both" SkinID="PagedList" OnRowDeleting="RelatedProductGrid_RowDeleting" OnDataBound="RelatedProductGrid_DataBound">
                                            <Columns>
                                                <asp:TemplateField>
                                        ...
                                        <asp:ObjectDataSource ID="RelatedProductsDs" runat="server" OldValuesParameterFormatString="original_{0}"
                                            SelectMethod="LoadForWrapGroup" TypeName="MakerShop.Products.ProductDataSource">
                                            <SelectParameters>
                                ...
                                <div class="section">
                                    ...
                                    <asp:Panel ID="SearchFormPanel" runat="server" CssClass="content" DefaultButton="SearchButton">
                                        ...
                                        <asp:ObjectDataSource ID="ProductSearchDs" runat="server" OldValuesParameterFormatString="original_{0}"
                                            SelectMethod="LoadForCriteria" SortParameterName="sortExpression" TypeName="MakerShop.Products.ProductDataSource"
