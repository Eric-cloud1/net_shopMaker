<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="BlackList.aspx.cs" Inherits="Admin_Rules_BlackList" Title="Untitled Page" %>
        ...
        <ContentTemplate>
            ...
            <table style="width:350px">
                 <tr class="noPrint">
                    <td style="width:40%;vertical-align:middle; ">
                        ...
                        <asp:DropDownList ID="dlBlackListDataSource"  runat="server" AutoPostBack="True" 
                                onselectedindexchanged="ProcessBlackListSelection_OnSelectedIndexChanged"/>
             <br />  
                    </td>
                ...
                <tr>
                    <td class="dataSheet" colspan="3">
                        ...
                        <asp:gridview  ID="lstBlackList" runat="server" AutoGenerateColumns="False" 
                            SkinID="PagedList" AllowPaging="true" PageSize="10" 
                             Width="100%" 
                             OnRowEditing="lstBlackList_EditCommand" 
                             OnPageIndexChanging="lstBlackList_PageIndexChanging"
                             
                             OnRowCancelingEdit="lstBlackList_CancelCommand" 
                            OnRowUpdating ="lstBlackList_UpdateCommand" 
                            >
                            <Columns>
                             <asp:TemplateField >
                                    ...
                                    <asp:Label ID="itemId"  Font-Size="0" style="visibility:hidden;" runat="server" Text='<%# Eval("BlackListId") %>' ></asp:Label>
                                  </ItemTemplate>
                              </asp:TemplateField>
                              
                                <asp:TemplateField HeaderText="Black List Value" ItemStyle-Width="150px" ItemStyle-HorizontalAlign="Center">
                                    ...
                                    <EditItemTemplate>                                       
                                         <asp:Label ID="lbId" runat="server"  Text='<%# Eval("BlackListId") %>' style="visibility:hidden;"  />
            ...
            <td valign="top" style="width: 350px">
                <div class="section">
                        ...
                        <div class="header">
                            <h2 class="addgroup">Add Black list items</h2>
                        </div>
                        <div class="content">
                            <div>
