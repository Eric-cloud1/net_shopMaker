...
AutoEventWireup="true" CodeFile="ViewProducts.aspx.cs"
Inherits="Admin_DigitalGoods_ViewProducts" Title="Digital Good Products" %> <%@
                  ...
                  <div class="section">
                    ...
                    <div class="content">
                      ...
                      >
                          ...
                          <asp:TemplateField HeaderText="Name">
                            <ItemTemplate>
                              <asp:HyperLink
                                ...
                                NavigateUrl='<%#Eval("Product.ProductId", "~/Admin/Products/DigitalGoods/DigitalGoods.aspx?ProductId={0}")%>'
                              />
                            </ItemTemplate>
                          </asp:TemplateField>
                          <asp:TemplateField>
                            ...
                            <ItemTemplate>
                              <asp:ImageButton
                                ...
                                ToolTip="Remove"
                                CommandArgument='<%#Eval("Product.ProductId")%>'
                        ...
                        <EmptyDataTemplate>
                          <asp:Label
                            ID="EmptyMessage"
                            runat="server"
                            Text="There are no products for this digital good."
                          ></asp:Label>
                        </EmptyDataTemplate>
                      </asp:GridView>
                      <asp:ObjectDataSource
                        ...
                        SelectMethod="LoadForDigitalGood"
                        TypeName="MakerShop.DigitalDelivery.ProductDigitalGoodDataSource"
                        SelectCountMethod="CountForDigitalGood"
                        SortParameterName="sortExpression"
                      >
                        <SelectParameters>
                          <asp:QueryStringParameter
                            Name="DigitalGoodId"
                            QueryStringField="DigitalGoodId"
                            Type="Object"
                          />
                        </SelectParameters>
                      </asp:ObjectDataSource>
                        ...
                        <tr>
                          <th class="rowHeader" style="text-align: left">
                            <cb:ToolTipLabel
                              ...
                              runat="server"
                              Text="SKU:"
                              ToolTip="Enter all or part of a product SKU.  Wildcard characters * and ? are accepted."
                            />
                          </th>
                          <td>
                            <asp:TextBox
                          ...
                          <asp:TemplateField HeaderText="Related">
                            ...
                            <itemtemplate>
                              <asp:ImageButton
                                ...
                                AlternateText="Add"
                                ToolTip="Assign to this digital good."
                                SkinId="AddIcon"
                                OnClientClick="this.visible=false"
                                OnClick="AttachButton_Click"
                                Visible="<%#!IsProductAssciated((Product)Container.DataItem)%>"
                              />
                              <asp:ImageButton
                                ID="RemoveButton"
                                runat="server"
                                CommandArgument="<%#Container.DataItemIndex%>"
                                AlternateText="Remove"
                                ToolTip="Remove from this digital good."
                                SkinId="DeleteIcon"
                                OnClientClick="this.visible=false"
