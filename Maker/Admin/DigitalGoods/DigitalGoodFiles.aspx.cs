...
public partial class Admin_DigitalGoods_DigitalGoodFiles : MakerShop.Web.UI.MakerShopAdminPage
{
    ...
    protected void AddButton_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            if (!DigitalGoodNameExists(Name.Text))
            {
                ...
                dg.Name = Name.Text;
                dg.FileSize = (int)(new FileInfo(Path.Combine(_DigitalGoodPath, fileName)).Length);
