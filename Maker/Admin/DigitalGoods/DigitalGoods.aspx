...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:ObjectDataSource ID="DigitalGoodDs" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="LoadForStore" TypeName="MakerShop.DigitalDelivery.DigitalGoodDataSource" 
        SelectCountMethod="CountForStore" SortParameterName="sortExpression" DataObjectTypeName="MakerShop.DigitalDelivery.DigitalGood" 
        DeleteMethod="Delete" UpdateMethod="Update" EnableViewState="false">
