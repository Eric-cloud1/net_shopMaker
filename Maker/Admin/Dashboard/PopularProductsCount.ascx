<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PopularProductsCount.ascx.cs" Inherits="Admin_Dashboard_PopularProductsCount" EnableViewState="false" %>
   ...
   <tr>
        <td valign="top">
            <ComponentArt:TabStrip ID="TabStrip1" runat="server" Width="100%" MultiPageId="MultiPage1" SkinID="HorizontalTab">
                <Tabs>
                    <ComponentArt:TabStripTab Text="By Sales Count"></ComponentArt:TabStripTab>
                    <ComponentArt:TabStripTab Text="Sales Quantity Data"></ComponentArt:TabStripTab>
