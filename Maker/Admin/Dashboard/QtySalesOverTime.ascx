<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QtySalesOverTime.ascx.cs" Inherits="Admin_Dashboard_QtySalesOverTime" EnableViewState="false" %>
   ...
   <tr>
        <td valign="top">
            <ComponentArt:TabStrip ID="TabStrip1" runat="server" Width="100%" MultiPageId="MultiPage1" SkinID="HorizontalTab">
                <Tabs>
                    <ComponentArt:TabStripTab Text="Qty Past 7 Days"></ComponentArt:TabStripTab>
                    <ComponentArt:TabStripTab Text="Qty Past 6 Months"></ComponentArt:TabStripTab>
                </Tabs>
