...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <table cellpadding="2" cellspacing="0" class="innerLayout">      
        <tr>
            ...
            SelectMethod="LoadForStore" TypeName="MakerShop.Products.VendorDataSource" SelectCountMethod="CountForStore" SortParameterName="sortExpression" DataObjectTypeName="MakerShop.Products.Vendor" DeleteMethod="Delete" InsertMethod="Insert" UpdateMethod="Update">
