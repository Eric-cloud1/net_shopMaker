...
CodeFile="DeleteVendor.aspx.cs" Inherits="Admin_People_Vendors_DeleteVendor"
Title="Delete Vendor" %> <%@ Register Assembly="MakerShop.Web"
    ...
    <tr>
        ...
        <ajax:UpdatePanel ID="EditAjax" runat="server" UpdateMode="Conditional">
          <ContentTemplate>
            <asp:Label
              ID="InstructionText"
              runat="server"
              Text="This vendor has one or more associated products.  Indicate what vendor these products should be changed to when {0} is deleted."
              EnableViewState="false"
            ></asp:Label>
              ...
              <tr>
                <th class="rowHeader">
                  <asp:Label
                    ...
                    runat="server"
                    Text="Move to Vendor:"
                    AssociatedControlID="VendorList"
                    ToolTip="New vendor for associated products"
                  ></asp:Label
                  ><br />
                </th>
                <td>
      ...
      <td valign="top" width="300">
                ...
                >
                  ...
                  <EmptyDataTemplate>
                    <asp:Label
                      ID="EmptyMessage"
                      runat="server"
                      Text="There are no products associated with this vendor."
                    ></asp:Label>
                  </EmptyDataTemplate>
                </cb:SortedGridView>
              </ContentTemplate>
        ...
        <asp:ObjectDataSource
          ...
          SelectCountMethod="CountForVendor"
          SelectMethod="LoadForVendor"
