<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditProducts.ascx.cs" Inherits="Admin_People_Manufacturers_EditProducts" %>
                                ...
                                <div class="section">
                                    ...
                                    <div class="content">
                                        <asp:GridView ID="RelatedProductGrid" runat="server" AutoGenerateColumns="False"
                                            ...
                                            Width="100%" GridLines="Both" SkinID="PagedList" OnRowDeleting="RelatedProductGrid_RowDeleting">
                                            <Columns>
                                            ...
                                            <EmptyDataTemplate>
                                                <asp:Label ID="EmptyMessage" runat="server" Text="There are no products for this manufacturer."></asp:Label>
                                            </EmptyDataTemplate>
                                        </asp:GridView>
                                        <asp:ObjectDataSource ID="RelatedProductsDs" runat="server" OldValuesParameterFormatString="original_{0}"
                                            SelectMethod="LoadForManufacturer" TypeName="MakerShop.Products.ProductDataSource">
                                            <SelectParameters>
                                ...
                                <div class="section">
                                    ...
                                    <asp:Panel ID="SearchFormPanel" runat="server" CssClass="content" DefaultButton="SearchButton">
                                        <table class="inputForm">
                                            ...
                                            <tr>
                                                <th class="rowHeader" style="text-align: left;">
                                                    <cb:ToolTipLabel ID="NoManufacturerLabel" runat="server" Text="Products without manufacturers only:"
                                                        ToolTip="Show products with that have no manufacturer assigned." />
                                                </th>
                                                <td>
                                                    <asp:CheckBox ID="NoManufacturer" runat="server" Checked="true" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2" align="right">
                                                    <asp:LinkButton ID="SearchButton" runat="server" Text="Search" SkinID="Button" OnClick="SearchButton_Click" /><br />
                                                </td>
                                            </tr>
                                        </table>
                                        <cb:SortedGridView ID="SearchResultsGrid" runat="server" AutoGenerateColumns="False"
                                            DataKeyNames="ProductId" GridLines="Both" SkinID="PagedList" DataSourceID="ProductSearchDs"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Manufacturer">
                                                    ...
                                                    <itemstyle horizontalalign="Center" />
                                                    <itemtemplate>
                                                <asp:Label ID="ManufacturerName" runat="server" Text='<%#((Product)Container.DataItem).Manufacturer != null? ((Product)Container.DataItem).Manufacturer.Name:""%>' SkinID="FieldHeader"  /><br />
                                            </itemtemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Related">
                                                    <itemstyle width="50px" horizontalalign="Center" />
                                                    <itemtemplate>
                                                <asp:ImageButton ID="AttachButton" runat="server" CommandArgument='<%#Container.DataItemIndex%>' AlternateText="Add" ToolTip="Assign to this manufacturer" SkinId="AddIcon" OnClientClick="this.visible=false" OnClick="AttachButton_Click" Visible='<%#!IsProductLinked((Product)Container.DataItem)%>' />
                                                <asp:ImageButton ID="RemoveButton" runat="server" CommandArgument='<%#Container.DataItemIndex%>' AlternateText="Remove" ToolTip="Remove from this manufacturer" SkinId="DeleteIcon" OnClientClick="this.visible=false" OnClick="RemoveButton_Click" Visible='<%#IsProductLinked((Product)Container.DataItem)%>' />
                                            </itemtemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                            <EmptyDataTemplate>
                                        ...
                                        <asp:ObjectDataSource ID="ProductSearchDs" runat="server" OldValuesParameterFormatString="original_{0}"
                                            SelectMethod="FindProducts" SortParameterName="sortExpression" TypeName="MakerShop.Products.ProductDataSource"
