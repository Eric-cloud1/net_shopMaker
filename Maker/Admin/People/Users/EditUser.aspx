...
<%@ Register src="RelatedOrderDialog.ascx" tagname="RelatedOrderDialog" tagprefix="uc" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <asp:UpdatePanel ID="PageAjax" runat="server">
        <ContentTemplate>
            <div class="pageHeader">
    	        <div class="caption">
    		        <h1><asp:Localize ID="Caption" runat="server" Text="Edit User: {0}"></asp:Localize>
                    ...
                    <td valign="top">
                        <ComponentArt:TabStrip ID="EditUserTabs" runat="server" MultiPageId="EditUserPages" SkinID="HorizontalTab">
                            <Tabs>
                                ...
                                <ComponentArt:TabStripTab ID="OrdersTab" Text="Orders" Visible="false"></ComponentArt:TabStripTab>
                                <ComponentArt:TabStripTab ID="RelatedOrderTab" Text="Related Orders"></ComponentArt:TabStripTab>
                                <ComponentArt:TabStripTab ID="PageViewsTab" Text="Page Views" Visible="false"></ComponentArt:TabStripTab>
                            </Tabs>
                ...
                <tr>
                    <td valign="top">
                        <ComponentArt:MultiPage ID="EditUserPages" CssClass="hTab_MultiPage" runat="server">
                                        ...
                                        <td style="border-right:solid 1px grey;width:450px" valign="top">
                                            ...
                                            <table class="inputForm">
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:Panel ID="ChangeGroupListDialog" runat="server" Style="display: none" CssClass="modalPopup" Width="600px">
                                                            <asp:Panel ID="ChangeGroupListDialogHeader" runat="server" CssClass="modalPopupHeader">
                                                                Change Assigned Groups</asp:Panel>
                                                            <div align="center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:CheckBox ID="IsDisabled" runat="server"></asp:CheckBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>&nbsp;</td>
                            ...
                            <ComponentArt:PageView ID="RelatedOrdersPage" runat="server">
                               <uc:RelatedOrderDialog ID="RelatedOrderDialog1" runat="server" />
                            </ComponentArt:PageView>
