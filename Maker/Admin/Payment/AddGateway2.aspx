<%@ Page Language="C#" MasterPageFile="../Admin.master" CodeFile="AddGateway2.aspx.cs"
    Inherits="Admin_Payment_AddGateway2" Title="Add Gateway" %>
                    ...
                    <table class="inputForm" width="100%">
                        ...
                        <tr>
                            <td>
                                ...
                                <div align="center">
                                    <asp:CheckBoxList runat="server" ID="PaymentInstrumentList" RepeatDirection="Horizontal"
                                        RepeatColumns="2" CellPadding="3" Width="300px">
