...
public partial class Admin_Payment_GatewayResponse : MakerShop.Web.UI.MakerShopAdminPage
{
    ...
    protected void Grid_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        GatewayResponseAction x = GatewayResponseActionDataSource.Load(id);
        if (x != null)
        {
            AddPanel.Visible = false;
            EditPanel.Visible = true;
            EditCaption.Text = string.Format(EditCaption.Text, x.Response);
            ASP.admin_payment_gatewayresponse_editgatewayresponsedialog_ascx
                editDialog = EditPanel.FindControl("EditDialog1") as ASP.admin_payment_gatewayresponse_editgatewayresponsedialog_ascx;
    ...
    {
        Grid.DataSource = GatewayResponseActionDataSource.LoadForCriteria("");
        Grid.DataBind();
    }
    ...
    protected void Grid_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Delete")
            Ds.DeleteParameters[0].DefaultValue = e.CommandArgument.ToString();
