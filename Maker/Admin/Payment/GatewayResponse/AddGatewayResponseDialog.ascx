<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AddGatewayResponseDialog.ascx.cs"
    Inherits="Admin_Payment_AddGatewayResponseDialog" %>
...
<table cellpadding="4" cellspacing="0" class="inputForm" width="100%">
    ...
    <tr>
        <td colspan="2">
            ...
            <asp:Label ID="AddedMessage" runat="server" Text="Gateway Response {0} added." SkinID="GoodCondition"
