...
public partial class Admin_Payment_Templates : MakerShop.Web.UI.MakerShopAdminPage
{
    ...
    protected void Grid_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        if (pt != null)
        {
            ...
            ASP.admin_payment_editpaymentgatewaytemplatedialog_ascx editDialog = EditPanel.FindControl("EditDialog1") as ASP.admin_payment_editpaymentgatewaytemplatedialog_ascx;
    ...
    protected string GetGateways(object dataItem)
    {
        ...
        {
            if (!pg.Contains(pga.PaymentMethod.PaymentGateway.Name))
                pg.Add(pga.PaymentMethod.PaymentGateway.Name);
        }
