using MakerShop.Shipping.Providers.AustraliaPost;
using System;
using System.Web;
using MakerShop.Shipping;
using MakerShop.Utility;

partial class Admin_Shipping_Providers_AustraliaPost_Default : MakerShop.Web.UI.MakerShopAdminPage {
	...
	{
		StoreName.Text = MakerShop.Common.Token.Instance.Store.Name;
    ...
    protected void RegisterButton_Click(object sender, System.EventArgs e) {
		...
		string terms = MakerShop.Common.Token.Instance.Store.Settings.CheckoutTermsAndConditions;
