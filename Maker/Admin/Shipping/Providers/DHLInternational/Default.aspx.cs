...
public partial class Admin_Shipping_DHLInternational_Default : MakerShop.Web.UI.MakerShopAdminPage
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        {
            DHLInternational provider = _ShipGateway.GetProviderInstance() as DHLInternational;
            if (provider != null)
            {
