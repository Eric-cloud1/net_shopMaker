...
CodeFile="EditShipMethodFixed.aspx.cs"
Inherits="Admin_Shipping_Methods_EditShipMethodFixed" Title="Edit Shipping
            ...
            <tr>
              ...
              <td colspan="3">
                ...
                <asp:RequiredFieldValidator
                  ...
                  Display="Static"
                  ErrorMessage="Ship rate is required."
                  >*</asp:RequiredFieldValidator
                >
              </td>
            </tr>
            <tr>
              <th class="rowHeader" valign="top">
                <cb:ToolTipLabel
                  ...
                  runat="server"
                  Text="Handling Fee:"
                  ToolTip="Specify a surcharge or handling fee that is associated with this method.  You can set surcharges as a fixed amount or a percentage of the shipping charge.  You can also choose to include the surcharge in the total shipping rate or display as a separate line item in the order."
                />
              </th>
