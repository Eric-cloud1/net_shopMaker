...
CodeFile="EditShipMethodMatrix.aspx.cs"
Inherits="Admin_Shipping_Methods_EditShipMethodMatrix" Title="Edit Ship Method"
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <table cellpadding="2" cellspacing="0" class="innerLayout">
    <tr>
      <td colspan="2">
        <asp:Label
          ID="RateMatrixHelpText"
          runat="Server"
          Text="Use the table to configure the ship rate by range of <b>{0}</b>.  Enter the minimum and maximum values for the range, and the rate to charge when the value for a shipment falls within the range.  Rates can either be fixed or calculated as a percentage.  Be careful not to overlap your ranges, otherwise you cannot be sure which rate will be applied when calculating charges."
          EnableViewState="false"
        ></asp:Label
        ><br /><br />
          ...
          <table class="inputForm" cellpadding="4" width="700px">
            ...
            <tr>
              <th class="rowHeader" valign="top" align="right">
                <cb:ToolTipLabel
                  ...
                  runat="server"
                  Text="Ship Rate:"
                  ToolTip="The amount charged for this shipping method."
                />
              </th>
                ...
                >
                  <ContentTemplate>
                    <asp:GridView
                      ...
                      DataKeyNames="ShipRateMatrixId"
                      OnRowDeleting="RateMatrixGrid_RowDeleting"
                      SkinID="PagedList"
                    >
                      <Columns>
                        <asp:TemplateField HeaderText="Min">
                          ...
                          <ItemTemplate>
                            <asp:TextBox
                              ID="RangeStart"
                              runat="server"
                              Text='<%# Eval("RangeStart", "{0:#.##;(#.##);}") %>'
                              Columns="4"
                              MaxLength="11"
                            ></asp:TextBox>
                            <asp:RangeValidator
                              ID="RangeStartValidator"
                              runat="server"
                              Text="*"
                              Type="currency"
                              ErrorMessage="Minimum value should be between 0.00 and 99999999.99"
                              ControlToValidate="RangeStart"
                              MinimumValue="0"
                        ...
                        <asp:TemplateField HeaderText="Max">
                          ...
                          <ItemTemplate>
                            <asp:TextBox
                              ID="RangeEnd"
                              runat="server"
                              Text='<%# Eval("RangeEnd", "{0:#.##;(#.##);}") %>'
                              Columns="4"
                              MaxLength="11"
                            ></asp:TextBox>
                            <asp:RangeValidator
                              ID="RangeEndValidator"
                              runat="server"
                              Text="*"
                              Type="currency"
                              ErrorMessage="Maximum value should be between 0.00 and 99999999.99"
                              ControlToValidate="RangeEnd"
                              MinimumValue="0"
                              MaximumValue="99999999.99"
                            ></asp:RangeValidator>
                        ...
                        <asp:TemplateField HeaderText="Rate">
                          ...
                          <ItemTemplate>
                            ...
                            <asp:RangeValidator
                              ...
                              Text="*"
                              Type="currency"
                              ErrorMessage="Rate value should be between 0.00 and 99999999.99"
                        ...
                        <asp:TemplateField ShowHeader="False">
                          ...
                          <ItemTemplate>
                            <asp:ImageButton
                              ...
                              SkinID="DeleteIcon"
                              CommandName="Delete"
                              CommandArgument='<%#Eval("ShipRateMatrixId")%>'
                            />
                          </ItemTemplate>
                        </asp:TemplateField>
                      </Columns>
            ...
            <tr>
              ...
              <td valign="top" colspan="3">
                ...
                ></asp:TextBox>
                <asp:RangeValidator
                  ID="SurchargeValidator"
                  runat="server"
                  Text="*"
                  Type="currency"
                  ErrorMessage="Handling Fee value should be between 0.00 and 99999999.99"
                  ControlToValidate="Surcharge"
                  MinimumValue="0"
                  MaximumValue="99999999.99"
                ></asp:RangeValidator>
