...
Inherits="Admin_Shipping_Zones_Default" Title="Zones" %> <%@ Register
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
        ...
        <tr>
          ...
          >
            <cb:SortedGridView
              ...
              DataKeyNames="ShipZoneId"
              DataSourceID="ShipZoneDs"
              ShowFooter="False"
              Width="100%"
              SkinID="PagedList"
              DefaultSortExpression="Name"
              OnRowCommand="ShipZoneGrid_RowCommand"
            >
              <Columns>
                <asp:TemplateField HeaderText="Name" SortExpression="Name">
                  ...
                  <ItemTemplate>
                    <asp:HyperLink
                      ID="NameLink"
                      runat="server"
                      NavigateUrl='<%#Eval("ShipZoneId", "EditShipZone.aspx?ShipZoneId={0}")%>'
                      Text='<%# Eval("Name") %>'
                    ></asp:HyperLink>
                  </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Countries">
                  ...
                  <ItemTemplate>
                    <asp:Label
                      ID="CountriesLabel"
                      runat="server"
                      Text="<%#GetCountryNames(Container.DataItem)%>"
                    ></asp:Label>
                  </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Provinces">
                  ...
                  <ItemTemplate>
                    <asp:Label
                      ID="ProvincesLabel"
                      runat="server"
                      Text="<%#GetProvinceNames(Container.DataItem)%>"
                    ></asp:Label>
                  </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Postal Codes">
                  ...
                  <ItemTemplate>
                    <asp:Label
                      ID="PostalCodesLabel"
                      runat="server"
                      Text="<%#GetPostalCodes(Container.DataItem)%>"
                    ></asp:Label>
                  </ItemTemplate>
                </asp:TemplateField>
          ...
          <td class="detailPanel">
            <div class="section">
              <div class="header">
                <h2 class="addshippingzone">
                  <asp:Localize
                    ID="AddShipZoneCaption"
                    runat="server"
                    Text="Add Zone"
                  />
                </h2>
              ...
              <div class="content">
                ...
                <asp:RequiredFieldValidator
                  ID="AddShipZoneNameRequired"
                  runat="server"
                  ControlToValidate="AddShipZoneName"
                  Display="Static"
                ...
                ></asp:RequiredFieldValidator>
                <asp:Button
                  ID="AddShipZoneButton"
                  runat="server"
                  Text="Add"
                  OnClick="AddShipZoneButton_Click"
                  ValidationGroup="Add"
                />
              </div>
            </div>
  ...
  <asp:ObjectDataSource
    ...
    TypeName="MakerShop.Shipping.ShipZoneDataSource"
    SelectCountMethod="CountForStore"
    SortParameterName="sortExpression"
    DataObjectTypeName="MakerShop.Shipping.ShipZone"
    DeleteMethod="Delete"
    InsertMethod="Insert"
    UpdateMethod="Update"
  >
