...
Inherits="Admin_Shipping_Warehouses_ViewProducts" Title="Warehouse Products"
Debug="true"%> <%@ Register Assembly="MakerShop.Web"
    ...
    <tr>
      ...
      <td align="right">
        <asp:Panel ID="NewWarehousePanel" runat="server">
          ...
          <asp:Button
            ID="NewWarehouseUpdateButton"
            runat="server"
            Text="Go"
            OnClick="NewWarehouseUpdateButton_Click"
          />
        </asp:Panel>
      </td>
    </tr>
