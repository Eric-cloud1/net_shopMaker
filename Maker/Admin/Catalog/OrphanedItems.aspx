...
AutoEventWireup="true" CodeFile="OrphanedItems.aspx.cs"
Inherits="Admin_Catalog_OrphanedItems" Title="Orphaned Items" %> <%@ Register
  ...
  <table cellpadding="2" cellspacing="0" class="innerLayout">
    <tr>
      <td align="left">
        ...
        <ul>
          <asp:RadioButtonList
            ID="CatalogItemTypeList"
            runat="server"
            OnSelectedIndexChanged="CatalogItemTypeList_SelectedIndexChanged"
            AutoPostBack="true"
          >
    ...
    <tr id="CatalogItemsPanel" runat="server">
      <td colspan="2">
            ...
            <asp:TemplateField>
              <ItemTemplate>
                ...
                <asp:ImageButton
                  ...
                  CommandArgument="<%#Eval(GetIdFieldName(Container.DataItem)) %>"
        ...
        <asp:ObjectDataSource
          ...
          SelectMethod="LoadOrphaned"
          TypeName="MakerShop.Catalog.CategoryDataSource"
          EnablePaging="true"
        ...
        <asp:ObjectDataSource
          ...
          OldValuesParameterFormatString="original_{0}"
          SelectMethod="LoadOrphaned"
          TypeName="MakerShop.Catalog.WebpageDataSource"
          EnablePaging="true"
          EnableViewState="false"
          SortParameterName="sortExpression"
        >
        ...
        <asp:ObjectDataSource
          ...
          OldValuesParameterFormatString="original_{0}"
          SelectMethod="LoadOrphaned"
          TypeName="MakerShop.Catalog.LinkDataSource"
          EnablePaging="true"
          EnableViewState="false"
          SortParameterName="sortExpression"
        >
    ...
    <tr id="ImagesPanel" runat="server" visible="false">
      <td colspan="2">
        ...
        >
          <div>
            <asp:Label
              ID="FailureMessagesHeader"
              runat="server"
              SkinID="ErrorCondition"
              Text="Access denied, following file(s) can not be deleted:"
            ></asp:Label>
            <asp:BulletedList ID="Messages" runat="server"> </asp:BulletedList>
            <br />
          </div>
        </asp:Panel>
        List of files that are present in the "~Assets/ProductImages" folder at
        your store and are not associated to any product, category, webpage or
        link.
        <table cellpadding="2" cellspacing="0" class="innerLayout">
          <tr>
            <td valign="top">
              <cb:SortedGridView
                ...
                AllowPaging="true"
                PageSize="20"
                OnPageIndexChanging="ImageFilesGrid_PageIndexChanging"
              >
                <Columns>
                  <asp:TemplateField>
                  ...
                  <asp:TemplateField HeaderText="File">
                    ...
                    <ItemTemplate>
                      ...
                      <a
                        ...
                        title="View image."
                        onmouseover='<%# Eval("Name", "ImageLookupHoverPanel.startCallback(event,\"ImageName={0}\",null,null);")%>'
                        onmouseout="ImageLookupHoverPanel.hide();"
                        ><asp:ImageButton
                          ID="PreviewImageIcon"
                          runat="server"
                          SkinId="PreviewIcon"
                  ...
                  <asp:BoundField
                    DataField="FileItemType"
                    HeaderText="File Type"
                    SortExpression="FileItemType"
                  >
                    <HeaderStyle HorizontalAlign="Left" />
                  </asp:BoundField>
                  <asp:TemplateField HeaderText="Size">
                    ...
                    <ItemTemplate>
                      <asp:Label
                        ID="Size"
                        runat="server"
                        Text='<%# GetFileSize((long)Eval("Size")) %>'
                      ></asp:Label>
                    </ItemTemplate>
                  </asp:TemplateField>
                  <asp:BoundField
          ...
          <tr>
            <td align="left">
              <asp:Button
                ...
                OnClientClick="if(FilesChecked()){return confirm('Are you sure you want to delete all selected files?');} else {alert ('Please select a file first.'); return false;}"
              />
            </td>
          </tr>
        </table>
