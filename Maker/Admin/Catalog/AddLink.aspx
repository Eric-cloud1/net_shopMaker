<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddLink.aspx.cs"
Inherits="Admin_Catalog_AddLink" MasterPageFile="~/Admin/Catalog.master"
Title="Add Link"%> <%@ Register Assembly="MakerShop.Web"
          ...
          <tr>
            <th class="rowHeader" nowrap>
              <cb:ToolTipLabel
                ...
                runat="server"
                Text="Link Url:"
                AssociatedControlID="TargetUrl"
                ToolTip="The url that is associated with this link."
              ></cb:ToolTipLabel>
            </th>
            <td>
              <asp:TextBox
              ...
              ></asp:TextBox>
              <asp:RequiredFieldValidator
                ID="TargetUrlRequiredValidator"
                runat="server"
                Text="*"
                Display="Dynamic"
                ErrorMessage="Link URL is required."
                ControlToValidate="TargetUrl"
              ></asp:RequiredFieldValidator>
            </td>
            <th class="rowHeader">
              <cb:ToolTipLabel
                ...
                runat="server"
                Text="TargetWindow:"
                AssociatedControlID="TargetWindow"
                ToolTip="The target window for the link when it is opened."
              ></cb:ToolTipLabel>
            </th>
            <td>
              <asp:DropDownList ID="TargetWindow" runat="server">
                ...
                <asp:ListItem
                  Value="_self"
                  Text="Current Frame (_self)"
                ></asp:ListItem>
                <asp:ListItem
                  Value="_blank"
                  Text="New Window (_blank)"
                ></asp:ListItem>
                <asp:ListItem
                  Value="_top"
                  Text="Top Window (_top)"
                ></asp:ListItem>
              </asp:DropDownList>
            </td>
          </tr>
          ...
          <tr>
            <th class="rowHeader" valign="top">
              <cb:ToolTipLabel
                ...
                ToolTip="Description of the item that may be shown on some display pages."
              ></cb:ToolTipLabel>
            </th>
            <td colspan="3">
              <asp:TextBox
          ...
          <tr>
            <th class="rowHeader" style="vertical-align: top">
              <cb:ToolTipLabel
                ...
                runat="server"
                Text="Description:"
                ToolTip="This is used by some display pages to show a detailed description or HTML content."
              ></cb:ToolTipLabel
              ><br />
              <asp:ImageButton
                ID="LinkDescriptionHtml"
                runat="server"
                SkinID="EditIcon"
              />
            </th>
          ...
          <tr>
            ...
            <th class="rowHeader" valign="top">
              <cb:ToolTipLabel
                ...
                ToolTip="Specifies the theme that will be used to display this item.  This is only applicable if a display page is used.  For direct links, this value is ignored."
              ></cb:ToolTipLabel>
            </th>
            <td valign="top">
              <asp:DropDownList
