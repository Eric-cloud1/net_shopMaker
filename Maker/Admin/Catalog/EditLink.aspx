...
CodeFile="EditLink.aspx.cs" Inherits="Admin_Catalog_EditLink" Title="Edit Link"
%> <%@ Register Assembly="MakerShop.Web"
Namespace="MakerShop.Web.UI.WebControls" TagPrefix="cb" %> <%@ Register
Src="~/Admin/Catalog/LinkMenu.ascx" TagName="LinkMenu" TagPrefix="uc" %>
<asp:Content
  ID="Content1"
        ...
        <table class="inputForm">
          ...
          <tr>
            ...
            <td>
              ...
              ></asp:TextBox>
              <asp:RequiredFieldValidator
                ID="NavigateUrlRequiredValidator"
                runat="server"
                Text="*"
                Display="Dynamic"
