...
<%@ Register Assembly="MakerShop.Web" Namespace="MakerShop.Web.UI.WebControls" TagPrefix="cc1" %>
                            ...
                            <div class="section">
                                ...
                                <div class="content">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Name">
                                                <ItemTemplate>
                                                    ...
                                                    <cc1:ToolTipLabel ID="NProductId" runat="server" Visible="false"  AssociatedControlID="N"  />
                                                </ItemTemplate>
                                    ...
                                    <asp:ObjectDataSource ID="CatalogDs" runat="server" OldValuesParameterFormatString="original_{0}" 
                                        SelectMethod="LoadForCategory" TypeName="MakerShop.Catalog.CatalogDataSource"
