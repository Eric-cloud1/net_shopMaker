...
CodeFile="EditWebpageCategories.aspx.cs"
Inherits="Admin_Catalog_EditWebpageCategories" Title="Edit Webpage Categories"
%> <%@ Register Assembly="ComponentArt.Web.UI" Namespace="ComponentArt.Web.UI"
TagPrefix="ComponentArt" %> <%@ Register Assembly="MakerShop.Web"
Namespace="MakerShop.Web.UI.WebControls" TagPrefix="cb" %> <%@ Register
Src="~/Admin/Catalog/WebpageMenu.ascx" TagName="WebpageMenu" TagPrefix="uc" %>
<asp:Content
  ID="Content1"
