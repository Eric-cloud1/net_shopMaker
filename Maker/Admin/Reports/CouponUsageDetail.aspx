...
CodeFile="CouponUsageDetail.aspx.cs" Inherits="Admin_Reports_CouponUsageDetail"
Title="Sales by Coupon" %> <%@ Register
Src="~/Admin/UserControls/PickerAndCalendar.ascx" TagName="PickerAndCalendar"
TagPrefix="uc1" %> <%@ Register TagPrefix="ComponentArt"
              ...
              <tr>
                <th class="rowHeader">
                  <asp:Label
                    ...
                    runat="server"
                    Text="Coupon Code:"
                    AssociatedControlID="CouponList"
                    ToolTip="Coupon to report on"
                  ></asp:Label>
                </th>
                <td>
                  <asp:DropDownList
                ...
                <th class="rowHeader">
                  <asp:Label
                    ...
                    runat="server"
                    Text="Time Period:"
                    AssociatedControlID="DateFilter"
                    ToolTip="Date range"
                  ></asp:Label>
                </th>
                <td>
              ...
              <tr>
                <th class="rowHeader">
                  <asp:Label
                    ...
                    runat="server"
                    Text="Start Date:"
                    AssociatedControlID="StartDate"
                    ToolTip="Start date for report"
                  ></asp:Label>
                </th>
                <td>
                  <uc1:PickerAndCalendar
                    id="StartDate"
                    runat="server"
                  ></uc1:PickerAndCalendar>
                </td>
  ...
  <ajax:UpdatePanel ID="ReportAjax" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
      ...
      <table cellpadding="2" cellspacing="0" class="innerLayout">
        <asp:Repeater
          ID="CouponSalesRepeater"
          runat="server"
          DataSourceID="CouponSalesDs"
          Visible="false"
        >
          <ItemTemplate>
            <tr class="sectionHeader">
              <th>
                <asp:Localize
                  ID="CouponName"
                  runat="server"
                  Text='<%# Eval("CouponCode", "Orders that used {0}") %>'
                ></asp:Localize>
              </th>
            </tr>
            <tr>
                ...
                >
                    ...
                    >
                      ...
                      <ItemTemplate>
                        <asp:HyperLink
                          ...
                          NavigateUrl='<%#String.Format("../Orders/ViewOrder.aspx?OrderNumber={0}&OrderId={1}", Eval("OrderNumber"), Eval("OrderId")) %>'
                          SkinId="Link"
                        ></asp:HyperLink>
                      </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    >
                      ...
                      <ItemTemplate>
                        <asp:Label
                          ID="OrderDate"
                          runat="server"
                          Text='<%# Eval("OrderDate", "{0:d}") %>'
                        ></asp:Label>
                      </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField
                      HeaderText="Products"
                      SortExpression="ProductSubtotal"
                    >
                      <HeaderStyle HorizontalAlign="Center" />
                      <ItemStyle HorizontalAlign="Center" />
                      <ItemTemplate>
                        <asp:Label
                          ID="Subtotal"
                          runat="server"
                          Text='<%# Eval("ProductSubtotal", "{0:lc}") %>'
                        ></asp:Label>
                      </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField
                      HeaderText="Total"
                      SortExpression="TotalCharges"
                    >
                      <HeaderStyle HorizontalAlign="Center" />
                      <ItemStyle HorizontalAlign="Center" />
                      <ItemTemplate>
                  ...
                  <EmptyDataTemplate>
                    <asp:Label
                      ID="EmptyMessage"
                      runat="server"
                      Text="There are no associated orders for this month."
                    ></asp:Label>
                  </EmptyDataTemplate>
                </asp:GridView>
              </td>
      ...
      <div align="center">
        <br /><i
          ><asp:Label
            ID="ReportTimestamp"
            runat="server"
            Text="Report generated {0:MMM-dd-yyyy hh:mm tt}"
            EnableViewState="false"
          ></asp:Label
        ></i>
        <div class="noPrint">
