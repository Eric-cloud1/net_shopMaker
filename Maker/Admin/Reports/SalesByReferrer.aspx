...
CodeFile="SalesByReferrer.aspx.cs" Inherits="Admin_Reports_SalesByReferrer"
Title="Sales by Referrer" %> <%@ Register
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <ContentTemplate>
        ...
        <div class="caption">
          <h1>
            <asp:Localize
              ID="Caption"
              runat="server"
              Text="Sales by Referrer"
            ></asp:Localize
            ><asp:Localize
              ID="ReportDateCaption"
              runat="server"
              Text=" for {0:MMMM yyyy}"
              Visible="false"
      ...
      >
        ...
        <tr>
          <td class="dataSheet">
            <cb:SortedGridView
              ID="ReferrerSalesGrid"
              runat="server"
              AutoGenerateColumns="False"
              DataSourceID="ReferrerSalesDs"
              AllowPaging="True"
              PageSize="20"
              SkinID="PagedList"
              AllowSorting="True"
              DefaultSortExpression="OrderCount"
                ...
                >
                  ...
                  <ItemTemplate>
                    <asp:Label
                      ID="ReferrerName"
                      runat="server"
                      Text='<%# ((String)Eval("Referrer")).Replace("/", "/<wbr />") %>'
                    ></asp:Label>
                  </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField
  ...
  <asp:ObjectDataSource
    ...
    SelectMethod="GetSalesByReferrer"
