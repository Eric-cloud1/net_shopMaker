<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Chargeback.aspx.cs" 
Inherits="Admin_Reports_ChargeBack_Chargeback" Title="Charges Back" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <ajax:UpdatePanel ID="ReportAjax" runat="server" UpdateMode="Conditional">
        ...
        <ContentTemplate>
            ...
            <table align="center" class="form" cellpadding="0" cellspacing="0" border="0" width="1000px"  >
      
                <uc1:DatesAndTime ID="dtChargeBack" runat="server" />
