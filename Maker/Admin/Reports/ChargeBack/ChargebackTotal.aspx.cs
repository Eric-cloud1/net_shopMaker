...
public partial class Admin_Reports_ChargeBack_ChargebackTotal : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            SessionDataSource = ReportDataSource.GetChargeBackByDate(dtChargeBackTotal.StartDate, dtChargeBackTotal.EndDate, int.Parse(paymentInstrument.SelectedValue));
    ...
    {
        this.dtChargeBackTotal.setDateTime();
        BindGrid();
    }
