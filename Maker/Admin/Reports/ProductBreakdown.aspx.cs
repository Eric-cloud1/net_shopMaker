...
public partial class Admin_Reports_ProductBreakdown : MakerShop.Web.UI.MakerShopAdminPage
{
    ...
    protected void BindGrid()
    {
        ...
        List<ProductBreakdownSummary> breakdownReport = ReportDataSource.GetProductBreakdownSummary(fromDate.Date, toDate.Date, AlwaysConvert.ToInt(VendorList.SelectedValue), SortByList.SelectedValue);
        int totalQuantity = 0;
