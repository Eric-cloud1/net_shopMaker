...
AutoEventWireup="true" CodeFile="WhoIsOnline.aspx.cs"
Inherits="Admin_Reports_WhoIsOnline" Title="Who Is Online?" %> <%@ Register
    ...
    <tr class="noPrint">
      <td>
        ...
        <asp:TextBox
          ...
          Width="30px"
        ></asp:TextBox>
        <asp:Label ID="LblMinutes" runat="server" EnableViewState="false"
          >minutes</asp:Label
        >
        <asp:Button
          ID="ApplyButton"
    ...
    <tr>
      <td class="dataSheet">
        <cb:SortedGridView
          ...
          DataSourceID="OnlineUserDs"
          DefaultSortExpression="LastActivityDate"
          DefaultSortDirection="Descending"
          AllowPaging="True"
          AllowSorting="true"
          PageSize="10"
          OnSorting="OnlineUserGrid_Sorting"
          Width="100%"
          SkinID="Summary"
        >
          <Columns>
            <asp:TemplateField HeaderText="User" SortExpression="UserName">
              <ItemTemplate>
                <asp:HyperLink
                  ID="UserLink"
                  runat="server"
                  Text='<%# ((User)Container.DataItem).IsAnonymous?"anonymous":Eval("UserName") %>'
            ...
            <asp:TemplateField HeaderText="IP Address">
              ...
              <ItemTemplate>
                <asp:Label
                  ID="IpAddressLabel"
                  runat="server"
                  Text="<%# GetIpAddress(Container.DataItem) %>"
                ></asp:Label>
              </ItemTemplate>
            </asp:TemplateField>
          </Columns>
