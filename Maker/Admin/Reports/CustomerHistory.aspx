...
CodeFile="CustomerHistory.aspx.cs" Inherits="Admin_Reports_CustomerHistory"
Title="Customers History" %> <%@ Register Assembly="MakerShop.Web"
    ...
    <div class="caption">
      <h1>
        <asp:Localize
          ID="Caption"
          runat="server"
          Text="Customer Navigation History"
        ></asp:Localize>
      </h1>
    </div>
  </div>
        ...
        >
          <Columns>
            ...
            <asp:TemplateField HeaderText="Page">
              <ItemTemplate> <%#GetUri(Container.DataItem)%> </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Time">
              <ItemTemplate> <%#Eval("TimeTaken", "{0}ms")%> </ItemTemplate>
            </asp:TemplateField>
            <asp:BoundField
              DataField="Referrer"
              HeaderText="Referrer"
