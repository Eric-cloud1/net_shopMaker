...
CodeFile="LowInventory.aspx.cs" Inherits="Admin_Reports_LowInventory" Title="Low
Inventory" %> <%@ Register TagPrefix="ComponentArt"
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="caption">
      <h1>
        <asp:Localize
          ID="Localize1"
          runat="server"
          Text="Products with Low Inventory"
        ></asp:Localize>
      </h1>
    </div>
  </div>
        ...
        >
          <ContentTemplate>
            ...
            <cb:SortedGridView
              ...
              DataSourceID="InventoryDs"
              DataKeyNames="ProductId,ProductVariantId"
              ...
              BorderColor="white"
              OnDataBound="InventoryGrid_DataBound"
              SkinID="Summary"
              Width="100%"
            >
              <Columns>
              ...
              <EmptyDataTemplate>
                <div class="emptyResult">
                  <asp:Label
                    ...
                    runat="server"
                    Text="There are no items currently at or below the low stock level."
                  ></asp:Label>
                </div>
              </EmptyDataTemplate>
            </cb:SortedGridView>
  ...
  <asp:ObjectDataSource
    ...
    SelectMethod="GetLowProductInventory"
    TypeName="MakerShop.Reporting.ProductInventoryDataSource"
