<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ForecastCapturedReport.aspx.cs" 
Inherits="Admin_Reports_ForecastCaptureReport" Title="Forecast Capture Report" %>
       ...
       <ContentTemplate>
            ...
            <div class="pageHeader">
                <div class="caption">
                    ...
                    <h1>
                    <asp:Localize ID="Caption" runat="server" Text="Forecast Capture Report"></asp:Localize>
             ...
             <table  class="form" cellpadding="0" cellspacing="0" border="0" width="100%">
              ...
              <tr>
               ...
               <uc1:DatesAndTime ID="dtForecastCapture" runat="server"  />
                   <tr>    
                ...
                <tr>
                <td style="width:10%" align="left"><asp:Label ID="lbSubaffiliates" Text="Subaffiliates:" runat="server" style="display:inline;font-weight:bold;width:110px;" /></td>
            ...
            <td>&nbsp; </td>
                ...
                <tr >
                    <td  colspan="7" align="left"> <div style="overflow-x:scroll;width:950px;">   <div id="grid">&nbsp;&nbsp;
                        <asp:GridView  ID="forecastReportgrid" runat="server" AutoGenerateColumns="true" 
                        OnPreRender="forecastReportgrid_PreRender" OnSorting="forecastReportgrid_Sorting" OnPageIndexChanging="forecastReportgrid_PageIndexChanging"
                        onrowdatabound="forecastReportgrid_RowDataBound"
