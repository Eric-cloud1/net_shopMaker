<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="SalesAbandon.aspx.cs" Inherits="Admin_Reports_SalesAbandon" 
Title="Sales Abandon" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <div class="pageHeader">
          <div class="caption">
              <h1>Abandonned Sales</h1>
          </div>
      </div>
<table cellpadding="0" cellspacing="0" width="100%">
<tr><td><div style="height:25px;">&nbsp;</div></td></tr>
    <tr><td><div style="vertical-align:middle; text-align:center; width:50%;"     
    <asp:Label ID="lbStartDate" runat="server" Text="Order Date: " SkinID="FieldHeader"></asp:Label>                 
                 <uc1:PickerAndCalendar ID="SalesDate"  runat="server" /> </div>            
    ...
    <tr>
        <td valign="top" colspan="2" style="background-color:#E3EFFF;">
                     ...
                     <web:chartcontrol runat="server" id="AbandonSalesChart" SkinID="Line" Visible="true"  Width="900" Height="600"
                    GridLines="Both" HasChartLegend="true" Legend-Width="130" Background-Type="Hatch"  ChartTitle-Text="Current Sales"   
                       CacheDuration="5" >
                     </web:chartcontrol>
                     
                     
                      <web:chartcontrol runat="server" id="AlertAbandonSalesChart" SkinID="AlertLine"  Width="900" Height="600"
                    GridLines="Both" HasChartLegend="true" Legend-Width="130" Background-Type="Hatch" Visible="false"  ChartTitle-Text="Current Sales"   
                       CacheDuration="5" >
                     </web:chartcontrol>
