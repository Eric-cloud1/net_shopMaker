<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ConversionLeadsOrder.aspx.cs" 
Inherits="Admin_Reports_Charts_ConversionLeadsOrder" Title="Conversion Leads to Order Charts" %>
...
<tr><td><div style="height:25px;">&nbsp;</div></td></tr>
    ...
    <tr>
     <td valign="top" colspan="2" style="background-color=#E3EFFF;">
                 ...
                 <web:chartcontrol runat="server" id="ConversionLeadsOrderChart" SkinID="Line" Visible="true" Width="900" Height="600"
                    GridLines="Both" HasChartLegend="true" Legend-Width="130" Background-Type="Hatch"  ChartTitle-Text="Conversion Leads Order"   
                       CacheDuration="5" >
                     </web:chartcontrol>
                     <web:chartcontrol runat="server" id="AlertConversionLeadsOrderChart" SkinID="alertLine" Visible="false"  Width="900" Height="600"
