<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="SalesCurrent.aspx.cs" Inherits="Admin_Reports_SalesCurrent"
 Title="Sales Current" %>
...
<tr><td><div style="height:25px;">&nbsp;</div></td></tr>
    ...
    <tr>
        <td valign="top" colspan="2" style="background-color:#E3EFFF;">
                 <web:chartcontrol runat="server" id="CurrentSalesChart" SkinID="Line"  Visible="true"  Width="900" Height="600"
                    GridLines="Both" HasChartLegend="true" Legend-Width="130" Background-Type="Hatch"  ChartTitle-Text="Current Sales"   
                       CacheDuration="5" >
                     </web:chartcontrol>
                      <web:chartcontrol runat="server" id="AlertCurrentSalesChart" SkinID="AlertLine" Visible="false"  Width="900" Height="600"
                    GridLines="Both" HasChartLegend="true" Legend-Width="130" Background-Type="Hatch"  ChartTitle-Text="Current Sales"   
                       CacheDuration="5" >
                     </web:chartcontrol>
