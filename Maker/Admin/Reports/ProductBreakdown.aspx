...
AutoEventWireup="true" Title="Product Breakdown"
CodeFile="ProductBreakdown.aspx.cs" Inherits="Admin_Reports_ProductBreakdown"%>
      ...
      >
        <tr>
          <th class="sectionHeader" colspan="4">
            <div style="text-align: left">Report Period</div>
          </th>
        </tr>
        <tr>
          <td>
        ...
        <tr>
          <td class="dataSheet" colspan="4">
            <asp:GridView
              ...
              Width="100%"
              SkinID="PagedList"
              OnPageIndexChanging="ProductBreakdownGrid_PageIndexChanging"
            >
              <Columns>
                ...
                <asp:TemplateField HeaderText="Amount">
                  ...
                  <ItemTemplate>
                    <asp:Label
                      ID="AmountLabel"
                      runat="server"
                      Text='<%# string.Format("{0:lc}", Eval("Amount")) %>'
                    ></asp:Label>
                  </ItemTemplate>
                </asp:TemplateField>
              </Columns>
              <EmptyDataTemplate>
                <div class="emptyResult">
                  <asp:Label
                    ...
                    runat="server"
                    Text="There are no products to report for the selected dates."
                  ></asp:Label>
                </div>
              </EmptyDataTemplate>
            </asp:GridView>
