...
CodeFile="SalesByAffiliateCustom.aspx.cs"
Inherits="Admin_Reports_SalesByAffiliateCustom" Title="Sales by Affiliate" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
      ...
      <table cellpadding="2" cellspacing="0" class="innerLayout">
              ...
              <tr>
                ...
                <td>
                  ...
                  >
                    ...
                    <asp:ListItem Value="11">All Dates</asp:ListItem>
                  </asp:DropDownList>
                </td>
                <th class="rowHeader">
                  <asp:Label
        ...
        <tr>
          <td class="dataSheet" align="center">
            <cb:SortedGridView
              ID="AffiliateSalesGrid"
              runat="server"
              AutoGenerateColumns="False"
              DataSourceID="AffiliateSalesDs"
              DefaultSortExpression="OrderTotal"
              DefaultSortDirection="Descending"
              AllowPaging="True"
              AllowSorting="true"
              PageSize="40"
              OnSorting="AffiliateSalesGrid_Sorting"
              Width="100%"
              SkinID="Summary"
              OnDataBound="AffiliateSalesGrid_DataBound"
            >
              <Columns>
                <asp:TemplateField HeaderText="Affiliate">
                  <ItemTemplate>
                    <asp:HyperLink
                      ID="AffiliateLink"
                      runat="server"
                      Text='<%# Eval("Affiliate.Name") %>'
                      NavigateUrl='<%#Eval("AffiliateId", "../Marketing/Affiliates/EditAffiliate.aspx?AffiliateId={0}")%>'
                    ></asp:HyperLink>
                  </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="">
                  ...
                  <ItemTemplate>
                    <asp:HyperLink
                      ...
                      runat="server"
                      Text="Detail"
                      NavigateUrl="<%#GetDetailUrl(Container.DataItem)%>"
                      SkinID="Link"
                    ></asp:HyperLink>
                  </ItemTemplate>
                </asp:TemplateField>
  ...
  <asp:ObjectDataSource
    ...
    SelectMethod="GetSalesByAffiliate"
