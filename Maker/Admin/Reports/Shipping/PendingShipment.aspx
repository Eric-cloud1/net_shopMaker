...
AutoEventWireup="true" CodeFile="PendingShipment.aspx.cs"
Inherits="Admin_Reports_Shipping_PendingShipment" Title="Pending Shipments
...
tagprefix="uc2" %> <%@ Register src="../../UserControls/DatesAndTime.ascx"
tagname="DatesAndTime" tagprefix="uc1" %>
  ...
  <ajax:UpdatePanel ID="ReportAjax" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
      ...
      <table
        ...
        width="100%"
      >
        <uc1:DatesAndTime ID="dtPendingShipment" runat="server" />
        ...
        <tr>
          <td class="dataSheet" colspan="3">
            <div style="overflow-x: scroll; width: 970px">
              <asp:GridView
                ID="pendingshipmentReportgrid"
                runat="server"
                AutoGenerateColumns="true"
                onrowdatabound="pendingshipmentReportgrid_RowDataBound"
                OnSorting="pendingshipmentReportgrid_Sorting"
                DefaultSortExpression="Name"
                DefaultSortDirection="Ascending"
                OnPreRender="pendingshipmentReportgrid_PreRender"
                AllowPaging="True"
                AllowSorting="true"
                SkinID="Summary"
                OnPageIndexChanging="pendingshipmentReportgrid_PageIndexChanging"
                PageSize="25"
                Width="950px"
              >
                <Columns> </Columns>
