...
public partial class Admin_Orders_ViewDigitalGoods : MakerShop.Web.UI.MakerShopAdminPage
{
    ...
    protected string GetLogins(OrderItemDigitalGood oidg)
    {

        if (oidg.DownloadCount == null)
            return "0";
        else
            return oidg.DownloadCount.ToString();
