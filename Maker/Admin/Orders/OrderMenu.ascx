...
<asp:Panel ID="OrderMenuPanel" runat="server">
   ...
   <!-- <asp:HyperLink ID="RelatedOrders" runat="server" NavigateUrl="RelatedOrders.aspx" Text="Related Orders" CssClass="contextMenuButton menu"></asp:HyperLink> -->
    ...
    <asp:HyperLink ID="CallDisposition" runat="server" NavigateUrl="CustomerService/CallDisposition.aspx" Text="Call Disposition" CssClass="contextMenuButton menu"></asp:HyperLink>
