...
public partial class Admin_Orders_Payments_RefundPayment : MakerShop.Web.UI.MakerShopAdminPage
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        RefundAmount.Enabled = ((_PaymentProvider.SupportedTransactions & SupportedTransactions.PartialRefund) == SupportedTransactions.PartialRefund);
    }
    ...
    protected void SubmitRefundButton_Click(object sender, EventArgs e)
    {
        ...
        if (refundAmount > 0 && _Payment.PaymentStatus == PaymentStatus.Captured)
        {
            ...
            refundRequest.ExtendedProperties.Add("Comment", CustomerNote.Text);
