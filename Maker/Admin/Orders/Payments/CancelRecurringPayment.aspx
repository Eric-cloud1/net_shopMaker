<%@ Page Language="C#" MasterPageFile="~/Admin/Orders/Order.master" CodeFile="CancelRecurringPayment.aspx.cs" Inherits="Admin_Orders_Payments_CancelRecurringPayment" Title="Void Payment" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    <div id="pageHeader1" style="width:100%">
        <h1 style="font-size: 18px; line-height: 22px">Void Payment</h1>
    </div>
    ...
    <table cellpadding="0" cellspacing="5">
        ...
        <tr id="trForceVoid" runat="server">
            <td colspan="2">
                The current payment method or processor does not support void transactions.  You may optionally enter a message to the customer, then submit the form to force the status of this payment to Void.  Be sure to void the payment offline if necessary.
            </td>
        </tr>
        <tr>
            <td align="right">
