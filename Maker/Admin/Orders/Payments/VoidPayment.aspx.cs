...
public partial class Admin_Orders_Payments_VoidPayment : MakerShop.Web.UI.MakerShopAdminPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (_Payment.PaymentMethod != null && (_Payment.PaymentMethod.IsCreditOrDebitCard() || 
                _Payment.PaymentMethod.PaymentInstrument == PaymentInstrument.PayPal))
            {
                ForcedVoidAuthorizationLabel.Visible = true;
                ForcedVoidPaymentLabel.Visible = false;
                this.Title = "Void Authorization";
                Caption.Text = "Void Authorization";
            }
            else
            {
                ForcedVoidAuthorizationLabel.Visible = false;
                ForcedVoidPaymentLabel.Visible = true;
