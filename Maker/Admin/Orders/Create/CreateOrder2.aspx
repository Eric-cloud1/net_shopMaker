            ...
            <ajax:UpdatePanel ID="BasketAjax" runat="server" UpdateMode="Conditional">
                <ContentTemplate>                                        
                    ...
                    <asp:Panel ID="OrderButtonPanel" runat="server">
                        <asp:LinkButton ID="ClearBasketButton" runat="server" SkinID="Button" OnClientClick="return confirm('Are you sure you want to clear the order contents?')" Text="Clear Order" OnClick="ClearBasketButton_Click"></asp:LinkButton>
                        <asp:LinkButton ID="UpdateButton" runat="server" SkinID="Button" OnClick="UpdateButton_Click" Text="Recalculate"></asp:LinkButton>
                        <asp:LinkButton ID="CheckoutButton" runat="server" SkinID="Button" OnClick="CheckoutButton_Click" Text="Place Order"></asp:LinkButton>
                    </asp:Panel>
                    <hr />                    
                        ...
                        <table width="100%">
                            <tr>
                                ...
                                <td valign="top">
                                    ...
                                    <asp:ObjectDataSource ID="AddProductDs" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="FindProducts" TypeName="MakerShop.Products.ProductDataSource" SortParameterName="sortExpression">
                                        <SelectParameters>
