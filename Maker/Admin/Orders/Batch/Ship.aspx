...
CodeFile="Ship.aspx.cs" Inherits="Admin_Orders_Batch_Ship" %> <%@ Register
Namespace="Westwind.Web.Controls" assembly="wwhoverpanel" TagPrefix="wwh" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
  <script type="text/javascript">
    function ShowHoverPanel(event, Id) {
      ShipmentHoverLookupPanel.startCallback(
        event,
        "OrderShipmentId=" + Id.toString(),
        null,
        OnError
      );
    }
  ...
  <asp:Panel ID="UpdatePanel" runat="server">
    ...
    <table cellpadding="2" cellspacing="0" class="innerLayout">
      <tr>
        <td>
          You have requested to ship these orders:
          <asp:Label ID="OrderList" runat="server"></asp:Label>
          <asp:Panel ID="InvalidOrdersPanel" runat="server">
            <br /><br /> WARNING: These orders do not currently have unshipped
            shipments:
            <asp:Label ID="InvalidOrderList" runat="server"></asp:Label>
          </asp:Panel>
        </td>
      </tr>
      <tr>
        <td>
              ...
              <asp:TemplateField HeaderText="Shipment #">
                ...
                <ItemTemplate>
                  <asp:HyperLink
                    ID="ShipmentNumber"
                    runat="server"
                    Text='<%# Eval("ShipmentNumber") %>'
                    SkinID="Link"
                    NavigateUrl="#"
                    OnMouseOver='<%# Eval("OrderShipmentId", "ShowHoverPanel(event, \"{0}\");")%>'
              ...
              <asp:TemplateField HeaderText="Bill To">
                ...
                <ItemTemplate>
                  <asp:Label
                    ID="BillToName"
                    runat="server"
                    Text='<%# string.Format("{1}, {0}", Eval("Order.BillToFirstName"), Eval("Order.BillToLastName")) %>'
                  ></asp:Label>
                </ItemTemplate>
              </asp:TemplateField>
              <asp:TemplateField HeaderText="Ship To">
                ...
                <ItemTemplate>
                  <asp:Label
                    ID="ShipToName"
                    runat="server"
                    Text='<%# string.Format("{1}, {0}", Eval("ShipToFirstName"), Eval("ShipToLastName")) %>'
                  ></asp:Label>
                </ItemTemplate>
              </asp:TemplateField>
              <asp:TemplateField HeaderText="Ship Date">
                ...
                <ItemTemplate>
                  <asp:TextBox
                    ...
                    runat="server"
                    MaxLength="10"
                    Text='<%# LocaleHelper.LocalNow.ToString("MM/dd/yyyy") %>'
                    Width="80px"
                  ></asp:TextBox>
                </ItemTemplate>
              </asp:TemplateField>
          ...
          <asp:ObjectDataSource
            ...
            TypeName="MakerShop.Shipping.ShipGatewayDataSource"
          >
          </asp:ObjectDataSource>
        </td>
      </tr>
  ...
  <asp:Panel ID="ConfirmPanel" runat="server" Visible="false">
    ...
    <table cellpadding="2" cellspacing="0" class="innerLayout">
      <tr>
        <td>The selected orders have been shipped.</td>
      </tr>
      <tr>
        <td>
          <asp:HyperLink
