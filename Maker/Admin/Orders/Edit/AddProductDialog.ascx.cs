...
public partial class Admin_Orders_Edit_AddProductDialog : System.Web.UI.UserControl
{
    ...
    public void Page_Init(object sender, EventArgs e)
    {
        ...
        ProductCalculator pcalc = ProductCalculator.LoadForProduct(_Product.ProductId, 1, optionList, AlwaysConvert.ToList(",", _SelectedKitProducts), _Order.UserId, PaymentTypes.Initial);
    ...
    protected void Price_PreRender(object sender, EventArgs e)
    {
        ...
        ProductCalculator pcalc = ProductCalculator.LoadForProduct(productId, 1, optionList, AlwaysConvert.ToList(",", _SelectedKitProducts), PaymentTypes.Initial);
        Price.Text = string.Format("{0:F2}", pcalc.Price);
    ...
    protected List<OrderItem> GetOrderItems()
    {
        ...
        List<OrderItem> orderItems = OrderItemDataSource.CreateForProduct(productId, tempQuantity, optionList, AlwaysConvert.ToList(",", _SelectedKitProducts), PaymentTypes.Initial);
