<%@ Page Language="C#"  CodeFile="ReturnShipment.aspx.cs" Inherits="Admin_Orders_ReturnShipment" Title="Cancel Order" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <tr>
        <td>
            ...
            <asp:LinkButton ID="CancelButton" runat="server" Text="Cancel Order" OnClick="CancelButton_Click" SkinID="Button" />
        </td>
    </tr>
</table>
</asp:Content>
