...
public partial class Admin_Orders_ReturnShipment : MakerShop.Web.UI.MakerShopAdminPage
{
    ...
    protected void CancelButton_Click(object sender, EventArgs e)
    {
        ...
        Order.Notes.Add(new OrderNote(OrderId, Token.Instance.UserId, DateTime.UtcNow, "RETURNED SHIPMENT", NoteType.Public));
        Order.Notes.Save();

        if (!string.IsNullOrEmpty(Comment.Text))
        {
            Order.Notes.Add(new OrderNote(OrderId, Token.Instance.UserId, DateTime.UtcNow, Comment.Text, NoteType.Public));
            Order.Notes.Save();
        }
