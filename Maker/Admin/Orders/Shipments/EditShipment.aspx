...
function QuantityCheck(qty)
{
    ...
    <table class="inputForm" cellpadding="4" cellspacing="0" style="margin-top:8px;" width="100%">
        ...
        <td colspan="3">
                ...
                <asp:LinkButton ID="AddTrackingNumber" runat="server" Text="Add Tracking Number" OnClick="AddTrackingNumber_Click" SkinID="Button" />
        </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
    ...
    <asp:ObjectDataSource ID="TrackingNumberDs" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="LoadForOrderShipment" 
        TypeName="MakerShop.Orders.TrackingNumberDataSource" SortParameterName="sortExpression" EnablePaging="true" 
