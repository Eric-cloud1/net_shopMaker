        ...
        <ContentTemplate>
            <asp:GridView ID="DigitalGoodsGrid" runat="server" AutoGenerateColumns="false" AllowPaging="false" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Activated<br/>or First Login" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Downloaded<br/>or Ordered" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="# Logins" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            
                            <asp:Literal ID="Logins" runat="server" Text='<%#GetLogins((OrderItemDigitalGood)Container.DataItem)%>' EnableViewState="false"></asp:Literal>
                        </ItemTemplate>
                    </asp:TemplateField>
