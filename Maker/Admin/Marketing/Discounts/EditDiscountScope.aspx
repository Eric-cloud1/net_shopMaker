...
AutoEventWireup="true" CodeFile="EditDiscountScope.aspx.cs"
Inherits="Admin_Marketing_Discounts_EditDiscountScope" Title="Discount Scope" %>
      ...
      <td colspan="2" width="100%">
        <p align="justify">
          <asp:Label
            ID="InstructionText"
            runat="server"
            Text="This discount will be applied to all of the assigned categories and/or products.  Use the tree on the left to navigate your categories and check the ones to be assigned to this discount.  You can also use the search form below to locate the specific products to be assigned.  Click Finish when you are done managing the categories and products for this discount."
          ></asp:Label
          ><br /><br />
        </p>
      </td>
                    ...
                    <asp:TemplateField HeaderText="Attached">
                      ...
                      <ItemTemplate>
                        <asp:Button
                          ...
                          Text="Add"
                          OnClientClick="this.value='Adding'"
                        ...
                        <asp:Button
                          ...
                          CommandArgument="<%#Container.DataItemIndex%>"
                          Text="Remove"
                          OnClientClick="this.value='Removing'"
            ...
            <div class="section">
              ...
              <div class="content">
                <cb:SortedGridView
                  ...
                  runat="server"
                  AutoGenerateColumns="False"
                  DataSourceID="VolumeDiscountProductsDs"
                  DataKeyNames="ProductId"
                  ShowHeader="False"
                  Width="100%"
                  GridLines="Both"
                ...
                >
                  ...
                  <EmptyDataTemplate>
                    <asp:Label
                      ID="EmptyMessage"
                      runat="server"
                      Text="There are no products associated with the discount."
                    ></asp:Label>
                  </EmptyDataTemplate>
                </cb:SortedGridView>
                <asp:ObjectDataSource
                  ID="VolumeDiscountProductsDs"
                  runat="server"
                  OldValuesParameterFormatString="original_{0}"
                  SelectMethod="LoadForVolumeDiscount"
                  SortParameterName="sortExpression"
                  TypeName="MakerShop.Products.ProductDataSource"
                  SelectCountMethod="CountForVolumeDiscount"
                >
                  <SelectParameters>
                    <asp:QueryStringParameter
                      Name="volumeDiscountId"
                      QueryStringField="VolumeDiscountId"
                      Type="Object"
                    />
                  </SelectParameters>
                </asp:ObjectDataSource>
