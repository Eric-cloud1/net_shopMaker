                        ...
                        <div class="section">
                            ...
                            <div class="content">
                                <cb:SortedGridView ID="ProductGrid" runat="server" AutoGenerateColumns="false" DataSourceID="FeaturedProductsDs"
                                    DataKeyNames="ProductId" ShowHeader="false" Width="100%" GridLines="Both" SkinID="PagedList" OnRowDataBound="ProductGrid_RowDataBound"  
                                ...
                                <asp:ObjectDataSource ID="FeaturedProductsDs" runat="server"
                                    ...
                                    TypeName="MakerShop.Products.ProductDataSource" SelectCountMethod="FindProductsCount">
                                    <SelectParameters>
                            ...
                            <div class="content">
                                <table class="inputForm">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <asp:LinkButton ID="SearchButton" runat="server" Text="Search" SkinID="Button" OnClick="SearchButton_Click" />                                        
                                        </td>
                                    </tr>
                                </table>
                                <cb:SortedGridView ID="SearchResultsGrid" runat="server" AutoGenerateColumns="False" DataKeyNames="ProductId" GridLines="Both" SkinId="PagedList" DataSourceId="ProductSearchDs"
                                ...
                                <asp:ObjectDataSource ID="ProductSearchDs" runat="server"
                                    OldValuesParameterFormatString="original_{0}" SelectMethod="FindProducts" SortParameterName="sortExpression"
                                    TypeName="MakerShop.Products.ProductDataSource" OnSelecting="ProductSearchDs_Selecting" 
