...
public partial class Admin_Marketing_Feeds_GoogleBase : MakerShopAdminPage
{
    GoogleBase feedProvider = null;
    ...
    String KeyFeedStatus = "MakerShop_GoogleBase_Store" + Token.Instance.StoreId + "_FeedStatus";
    String KeyFeedStatusMessageList = "MakerShop_GoogleBase_Store" + Token.Instance.StoreId + "_MessageList";
    String KeyFeedStatusMessage = "MakerShop_GoogleBase_Store" + Token.Instance.StoreId + "_Message";
    String KeyFeedStatusPercent = "MakerShop_GoogleBase_Store" + Token.Instance.StoreId + "_Percent";
    String KeyFeedStatusSuccess = "MakerShop_GoogleBase_Store" + Token.Instance.StoreId + "_Success";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            {
                FeedFileName.Text = "GoogleBaseData.txt";
            }
            ...
            {
                CompressedFeedFileName.Text = "GoogleBaseData.txt.zip";
            }
            ...
            {
                RemoteFileName.Text = "GoogleBaseData.txt";
            }
            else
            {
    ...
    {
        FeedOptions options = GetPostedOptions();
        options.Save(new GoogleBaseOptionKeys());
        List<string> messages = new List<string>();
