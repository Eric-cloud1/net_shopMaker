...
public partial class Admin_Marketing_Feeds_YahooShopping : MakerShopAdminPage
{
    ...
    String KeyFeedStatus = "MakerShop_YahooFeed_Store" + Token.Instance.StoreId + "_FeedStatus";
    String KeyFeedStatusMessageList = "MakerShop_YahooFeed_Store" + Token.Instance.StoreId + "_MessageList";
    String KeyFeedStatusMessage = "MakerShop_YahooFeed_Store" + Token.Instance.StoreId + "_Message";
    String KeyFeedStatusPercent = "MakerShop_YahooFeed_Store" + Token.Instance.StoreId + "_Percent";
    String KeyFeedStatusSuccess = "MakerShop_YahooFeed_Store" + Token.Instance.StoreId + "_Success";
