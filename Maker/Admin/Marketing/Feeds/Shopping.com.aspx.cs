...
using MakerShop.DataFeeds;
using MakerShop.Common;
using System.Collections.Generic;

public partial class Admin_Marketing_Feeds_Shopping_com : MakerShopAdminPage
{
    ShoppingComFeed feedProvider = null;
    ...
    String KeyFeedStatus = "MakerShop_ShoppingCom_Store" + Token.Instance.StoreId + "_FeedStatus";
    String KeyFeedStatusMessageList = "MakerShop_ShoppingCom_Store" + Token.Instance.StoreId + "_MessageList";
    String KeyFeedStatusMessage = "MakerShop_ShoppingCom_Store" + Token.Instance.StoreId + "_Message";
    String KeyFeedStatusPercent = "MakerShop_ShoppingCom_Store" + Token.Instance.StoreId + "_Percent";
    String KeyFeedStatusSuccess = "MakerShop_ShoppingCom_Store" + Token.Instance.StoreId + "_Success";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            options.Load(new ShoppingComOptionKeys());
            ...
            {
                FeedFileName.Text = "ShoppingComFeedData.csv";
            }
            ...
            {
                CompressedFeedFileName.Text = "ShoppingComFeedData.csv.zip";
            }
            ...
            {
                RemoteFileName.Text = "ShoppingComFeedData.csv";
            }
            else
            {
    ...
    {
        FeedOptions options = GetPostedOptions();
        options.Save(new ShoppingComOptionKeys());
        List<string> messages = new List<string>();
